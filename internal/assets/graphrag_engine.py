                ...
                result.append(
                    {
                        "from": {
                            "id": current,
                            "type": self.graph_manager.graph.nodes[current].get(
                                "asset_type"
                            ),
                            "name": self.graph_manager.graph.nodes[current].get(
                                "display_name"
                            ),
                        },
                        "to": {
                            "id": next_node,
                            "type": self.graph_manager.graph.nodes[next_node].get(
                                "asset_type"
                            ),
                            "name": self.graph_manager.graph.nodes[next_node].get(
                                "display_name"
                            ),
                        },
