...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/stop-instance.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/stop-instance.html)*
...
Specifies whether to force an instance to stop. If the instanceâs root device type is `ebs` , or EBS-backed, adding the `Force` parameter to the `StopInstances` API call disassociates the OpsWorks Stacks instance from EC2, and forces deletion of *only* the OpsWorks Stacks instance. You must also delete the formerly-associated instance in EC2 after troubleshooting and replacing the OpsWorks Stacks instance with a new one.
...
You can obtain an instance ID by going to the instanceâs details page on the AWS OpsWorks console or by
...
For more information, see [Stopping an Instance](http://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-starting.html#workinginstances-starting-stop) in the *AWS OpsWorks User Guide*.
