...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/delete-layer.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/delete-layer.html)*
...
You can obtain a layer ID by going to the layerâs details page on the AWS OpsWorks console or by
running the `describe-layers` command.

**Note:** Before deleting a layer, you must use `delete-instance` to delete all of the layerâs instances.
...
For more information, see [Deleting AWS OpsWorks Instances](http://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-delete.html) in the *AWS OpsWorks User Guide*.
