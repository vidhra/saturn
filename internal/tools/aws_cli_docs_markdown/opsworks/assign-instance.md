...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/assign-instance.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/assign-instance.html)*
...
For more information, see [Assigning a Registered Instance to a Layer](http://docs.aws.amazon.com/opsworks/latest/userguide/registered-instances-assign.html) in the *AWS OpsWorks User Guide*.
