...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/delete-instance.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/delete-instance.html)*
...
Whether to delete the instanceâs Amazon EBS volumes.
...
The following `delete-instance` example deletes a specified instance, which is identified by its instance ID. You can find an instance ID by opening the instanceâs details page in the AWS OpsWorks console, or by running the `describe-instances` command.
...
To remove the instanceâs Amazon EBS volumes or Elastic IP addresses, add the `--delete-volumes` or `--delete-elastic-ip` arguments, respectively.
...
For more information, see [Deleting AWS OpsWorks Instances](https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-delete.html) in the *AWS OpsWorks User Guide*.
