# update-my-user-profileÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-my-user-profile.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-my-user-profile.html)*
...
Updates a userâs SSH public key.
...
**To update a userâs profile**

The following example updates the `development` userâs profile to use a specified SSH public key.
The userâs AWS credentials are represented by the `development` profile in the `credentials` file
...
For more information, see [Editing AWS OpsWorks User Settings](http://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users-manage-edit.html) in the *AWS OpsWorks User Guide*.
