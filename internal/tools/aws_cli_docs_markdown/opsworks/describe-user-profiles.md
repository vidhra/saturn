# describe-user-profilesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-user-profiles.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-user-profiles.html)*
...
The following `describe-user-profiles` command describes the accountâs user profiles.
...
For more information, see [Managing AWS OpsWorks Users](http://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users-manage.html) in the *AWS OpsWorks User Guide*.
...
Describes a userâs SSH information.
