# register-elastic-ipÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/register-elastic-ip.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/register-elastic-ip.html)*
...
For more information, see [Registering Elastic IP Addresses with a Stack](http://docs.aws.amazon.com/opsworks/latest/userguide/resources-reg.html#resources-reg-eip) in the *OpsWorks User Guide*.
