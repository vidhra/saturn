# register-rds-db-instanceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/register-rds-db-instance.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/register-rds-db-instance.html)*
...
The databaseâs master user name.
...
It also specifies the instanceâs master username and password. Note that AWS OpsWorks does not validate either of these
