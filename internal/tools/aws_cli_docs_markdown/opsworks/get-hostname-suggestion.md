# get-hostname-suggestionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/get-hostname-suggestion.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/get-hostname-suggestion.html)*
...
this example is a Java Application Server layer with one instance. The stackâs hostname theme is
