...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-volume.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-volume.html)*
...
Updates an Amazon EBS volumeâs name or mount point. For more information, see [Resource Management](https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html) .
...
The following example updates a registered Amazon Elastic Block Store (Amazon EBS) volumeâs mount point.
...
For more information, see [Assigning Amazon EBS Volumes to an Instance](http://docs.aws.amazon.com/opsworks/latest/userguide/resources-attach.html#resources-attach-ebs) in the *AWS OpsWorks User Guide*.
