# describe-elastic-load-balancersÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-elastic-load-balancers.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-elastic-load-balancers.html)*
...
Describes a stackâs Elastic Load Balancing instances.
...
A stack ID. The action describes the stackâs Elastic Load Balancing instances.
...
**To describe a stackâs elastic load balancers**

The following `describe-elastic-load-balancers` command describes a specified stackâs load balancers.
...
The instanceâs Amazon Web Services Region.

DnsName -> (string)

The instanceâs public DNS name.
