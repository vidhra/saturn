# describe-my-user-profileÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-my-user-profile.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-my-user-profile.html)*
...
*Output*: For brevity, most of the userâs SSH public key is replaced by an ellipsis (â¦).
...
A `UserProfile` object that describes the userâs SSH information.
