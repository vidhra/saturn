# describe-rds-db-instancesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-rds-db-instances.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-rds-db-instances.html)*
...
**To describe a stackâs registered Amazon RDS instances**
...
The instanceâs address.

Engine -> (string)

The instanceâs database engine.
