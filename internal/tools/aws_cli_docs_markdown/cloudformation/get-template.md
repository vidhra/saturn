...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/get-template.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/get-template.html)*
...
If the template doesnât exist, a `ValidationError` is returned.
...
If the template doesnât include transforms, `Original` and `Processed` return the same template. By default, CloudFormation specifies `Processed` .
