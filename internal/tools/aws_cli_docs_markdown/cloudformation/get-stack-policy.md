...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/get-stack-policy.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/get-stack-policy.html)*
...
Returns the stack policy for a specified stack. If a stack doesnât have a policy, a null value is returned.
...
The name or unique stack ID thatâs associated with the stack whose policy you want to get.
