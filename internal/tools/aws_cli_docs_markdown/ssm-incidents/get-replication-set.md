# get-replication-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-incidents/get-replication-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-incidents/get-replication-set.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ssm-incidents-2018-05-10/GetReplicationSet)
...
Determines if the replication set deletion protection is enabled or not. If deletion protection is enabled, you canât delete the last Amazon Web Services Region in the replication set.
...
The map between each Amazon Web Services Region in your replication set and the KMS key thatâs used to encrypt the data in that Region.
...
The status of the replication set. If the replication set is still pending, you canât use Incident Manager functionality.