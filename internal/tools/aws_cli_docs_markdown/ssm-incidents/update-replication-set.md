# update-replication-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-incidents/update-replication-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-incidents/update-replication-set.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ssm-incidents-2018-05-10/UpdateReplicationSet)
...
Details about the Amazon Web Services Region that youâre adding to the replication set.
...
Details about the Amazon Web Services Region that youâre deleting to the replication set.

regionName -> (string)

The name of the Amazon Web Services Region youâre deleting from the replication set.
...
The Amazon Resource Name (ARN) of the replication set youâre updating.
