# increase-replication-factorÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dax/increase-replication-factor.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dax/increase-replication-factor.html)*
...
The following `increase-replication-factor` example increases the specified DAX clusterâs replication factor to 3.
