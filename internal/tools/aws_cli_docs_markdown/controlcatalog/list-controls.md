...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/controlcatalog/list-controls.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/controlcatalog/list-controls.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/controlcatalog-2018-05-10/ListControls)

`list-controls` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
