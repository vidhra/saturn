...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/controlcatalog/list-objectives.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/controlcatalog/list-objectives.html)*
...
You can apply an optional filter to see the objectives that belong to a specific domain. If you donât provide a filter, the operation returns all objectives.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/controlcatalog-2018-05-10/ListObjectives)
...
This filter allows you to specify one domain ARN at a time. Passing multiple ARNs in the `ObjectiveFilter` isnât currently supported.

Domains -> (list)

The domain thatâs used as filter criteria.

You can use this parameter to specify one domain ARN at a time. Passing multiple ARNs in the `ObjectiveFilter` isnât currently supported.

(structure)

The domain resource thatâs being used as a filter.
