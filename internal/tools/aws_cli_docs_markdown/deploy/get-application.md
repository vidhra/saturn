...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/get-application.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/get-application.html)*
...
The following `get-application` example displays information about an application that is associated with the userâs AWS account.
