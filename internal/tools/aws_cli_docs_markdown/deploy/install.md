...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/install.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/install.html)*
