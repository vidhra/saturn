# batch-get-applicationsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/batch-get-applications.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/batch-get-applications.html)*
...
The following `batch-get-applications` example displays information about multiple applications that are associated with the userâs AWS account.
