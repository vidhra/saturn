...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/update-application.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/update-application.html)*
...
The following `update-application` example changes the name of an application that is associated with the userâs AWS account.
