...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/list-applications.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/list-applications.html)*
...
The following `list-applications` example displays information about all applications that are associated with the userâs AWS account.
