# batch-create-delegation-by-assessmentÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/auditmanager/batch-create-delegation-by-assessment.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/auditmanager/batch-create-delegation-by-assessment.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/auditmanager-2017-07-25/BatchCreateDelegationByAssessment)
...
A collection of attributes thatâs used to create a delegation for an assessment in Audit Manager.

comment -> (string)

A comment thatâs related to the delegation request.
