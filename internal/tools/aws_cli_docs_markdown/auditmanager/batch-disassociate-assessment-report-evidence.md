# batch-disassociate-assessment-report-evidenceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/auditmanager/batch-disassociate-assessment-report-evidence.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/auditmanager/batch-disassociate-assessment-report-evidence.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/auditmanager-2017-07-25/BatchDisassociateAssessmentReportEvidence)
