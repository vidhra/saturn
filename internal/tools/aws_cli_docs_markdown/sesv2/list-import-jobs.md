...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/list-import-jobs.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/list-import-jobs.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/ListImportJobs)
...
- `CREATED` â Job has just been created.
- `PROCESSING` â Job is processing.
- `ERROR` â An error occurred during processing.
- `COMPLETED` â Job has completed processing successfully.
