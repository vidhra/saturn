# list-allowed-multi-region-cluster-updatesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/memorydb/list-allowed-multi-region-cluster-updates.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/memorydb/list-allowed-multi-region-cluster-updates.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/memorydb-2021-01-01/ListAllowedMultiRegionClusterUpdates)
