...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/reset-personal-pin.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/reset-personal-pin.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/ResetPersonalPIN)
...
**To reset a userâs personal meeting PIN**

The following `reset-personal-pin` example resets the specified userâs personal meeting PIN.
