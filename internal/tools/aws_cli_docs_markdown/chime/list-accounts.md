...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/list-accounts.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/list-accounts.html)*
...
Lists the Amazon Chime accounts under the administratorâs AWS account. You can filter accounts by account name prefix. To find out which Amazon Chime account a user belongs to, you can filter by the userâs email address, which returns one account result.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/ListAccounts)
...
The following `list-accounts` example retrieves a list of the Amazon Chime accounts in the administratorâs AWS account.
