...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/put-rest-api.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/put-rest-api.html)*
...
The `mode` query parameter to specify the update mode. Valid values are âmergeâ and âoverwriteâ. By default, the update mode is âmergeâ.
