# get-integration-responseÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-integration-response.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-integration-response.html)*
...
Specifies a get integration response requestâs resource identifier.

`--http-method` (string)

Specifies a get integration response requestâs HTTP method.

`--status-code` (string)

Specifies a get integration response requestâs status code.
...
**To get the integration response configuration for a HTTP method defined under a REST APIâs resource**
