...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-integration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-integration.html)*
...
Specifies a get integration requestâs resource identifier

`--http-method` (string)

Specifies a get integration requestâs HTTP method.
...
**To get the integration configuration for a HTTP method defined under a REST APIâs resource**
