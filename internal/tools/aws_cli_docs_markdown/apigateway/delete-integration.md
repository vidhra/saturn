...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-integration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-integration.html)*
...
Specifies a delete integration requestâs resource identifier.

`--http-method` (string)

Specifies a delete integration requestâs HTTP method.
