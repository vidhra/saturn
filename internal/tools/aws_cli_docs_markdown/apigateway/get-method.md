...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-method.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-method.html)*
...
**To get the method resource configuration for a HTTP method defined under a REST APIâs resource**
