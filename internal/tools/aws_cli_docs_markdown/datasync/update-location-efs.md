# update-location-efsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/update-location-efs.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/update-location-efs.html)*
...
Modifies the following configuration parameters of the Amazon EFS transfer location that youâre using with DataSync.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/datasync-2018-11-09/UpdateLocationEfs)
...
Specifies the Amazon Resource Name (ARN) of the Amazon EFS transfer location that youâre updating.
