# update-location-fsx-windowsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/update-location-fsx-windows.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/update-location-fsx-windows.html)*
...
Modifies the following configuration parameters of the Amazon FSx for Windows File Server transfer location that youâre using with DataSync.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/datasync-2018-11-09/UpdateLocationFsxWindows)
...
Specifies the ARN of the FSx for Windows File Server transfer location that youâre updating.
