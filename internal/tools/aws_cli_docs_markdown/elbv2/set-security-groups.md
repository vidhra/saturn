# set-security-groupsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/set-security-groups.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/set-security-groups.html)*
...
You canât perform this operation on a Network Load Balancer unless you specified a security group for the load balancer when you created it.

You canât associate a security group with a Gateway Load Balancer.
...
`--enforce-security-group-inbound-rules-on-private-link-traffic` (string)
