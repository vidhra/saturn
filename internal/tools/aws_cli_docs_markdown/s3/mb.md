...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3/mb.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3/mb.html)*
...
created in the region specified in the userâs configuration file:
