...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/wait/bucket-not-exists.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/wait/bucket-not-exists.html)*
...
The following `wait bucket-not-exists` example pauses and continues only after it can confirm that the specified bucket doesnât exist.
