# cancel-flow-executionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appflow/cancel-flow-executions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appflow/cancel-flow-executions.html)*
...
You can cancel a flow run only when the run is in progress. You canât cancel a run that has already completed or failed. You also canât cancel a run thatâs scheduled to occur but hasnât started yet. To prevent a scheduled run, you can deactivate the flow with the `StopFlow` action.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/appflow-2020-08-23/CancelFlowExecutions)
...
The IDs of runs that Amazon AppFlow couldnât cancel. These runs might be ineligible for canceling because they havenât started yet or have already completed.
