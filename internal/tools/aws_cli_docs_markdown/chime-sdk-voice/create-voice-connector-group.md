# create-voice-connector-groupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime-sdk-voice/create-voice-connector-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime-sdk-voice/create-voice-connector-group.html)*
...
Creates an Amazon Chime SDK Voice Connector group under the administratorâs AWS account. You can associate Amazon Chime SDK Voice Connectors with the Voice Connector group by including `VoiceConnectorItems` in the request.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/chime-sdk-voice-2022-08-03/CreateVoiceConnectorGroup)
...
The Voice Connector groupâs creation time stamp, in ISO 8601 format.
