# update-account-preferencesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/update-account-preferences.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/update-account-preferences.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/chatbot-2017-10-11/UpdateAccountPreferences)
...
[--training-data-collection-enabled | --no-training-data-collection-enabled]
...
`--training-data-collection-enabled` | `--no-training-data-collection-enabled` (boolean)
