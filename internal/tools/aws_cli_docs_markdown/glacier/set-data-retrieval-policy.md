# set-data-retrieval-policyÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/set-data-retrieval-policy.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/set-data-retrieval-policy.html)*
...
See [Set Data Retrieval Policy](http://docs.aws.amazon.com/amazonglacier/latest/dev/api-SetDataRetrievalPolicy.html) in the *Amazon Glacier API Reference* for details on the policy format.
