# disassociate-created-artifactÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgh/disassociate-created-artifact.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgh/disassociate-created-artifact.html)*
...
- Examples of the AWS resource behind the created artifact are, AMIâs, EC2 instance, or RDS instance, etc.
