# put-table-bucket-maintenance-configurationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3tables/put-table-bucket-maintenance-configuration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3tables/put-table-bucket-maintenance-configuration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/s3tables-2018-05-10/PutTableBucketMaintenanceConfiguration)
...
This is a Tagged Union structure. Only one of the following top level keys can be set: `icebergUnreferencedFileRemoval`.
...
```
status=string,settings={icebergUnreferencedFileRemoval={unreferencedDays=integer,nonCurrentDays=integer}}
```
