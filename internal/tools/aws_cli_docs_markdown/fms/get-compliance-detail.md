# get-compliance-detailÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fms/get-compliance-detail.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fms/get-compliance-detail.html)*
...
An array of resources that arenât protected by the WAF or Shield Advanced policy or that arenât in compliance with the security group policy.
...
Metadata about the resource that doesnât comply with the policy scope.
