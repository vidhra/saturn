# detect-dominant-languageÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/detect-dominant-language.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/detect-dominant-language.html)*
...
The following `detect-dominant-language` analyzes the input text and identifies the dominant language. The pre-trained modelâs confidence score is also output.
