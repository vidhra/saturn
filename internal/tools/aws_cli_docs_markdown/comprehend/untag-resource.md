...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/untag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/untag-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/UntagResource)
...
The initial part of a key-value pair that forms a tag being removed from a given resource. For example, a tag with âSalesâ as the key might be added to a resource to indicate its use by the sales department. Keys must be unique and cannot be duplicated for a particular resource.
