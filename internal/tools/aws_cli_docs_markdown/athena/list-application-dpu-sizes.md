# list-application-dpu-sizesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/list-application-dpu-sizes.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/list-application-dpu-sizes.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/athena-2017-05-18/ListApplicationDPUSizes)
