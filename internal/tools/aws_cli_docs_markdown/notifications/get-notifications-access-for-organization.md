# get-notifications-access-for-organizationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/get-notifications-access-for-organization.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/get-notifications-access-for-organization.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/notifications-2018-05-10/GetNotificationsAccessForOrganization)
...
notificationsAccessForOrganization -> (structure)
