# disassociate-managed-notification-additional-channelÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/disassociate-managed-notification-additional-channel.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/disassociate-managed-notification-additional-channel.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/notifications-2018-05-10/DisassociateManagedNotificationAdditionalChannel)
