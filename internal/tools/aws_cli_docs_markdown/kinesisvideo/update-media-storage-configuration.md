# update-media-storage-configurationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisvideo/update-media-storage-configuration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisvideo/update-media-storage-configuration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/UpdateMediaStorageConfiguration)
...
update-media-storage-configuration
--channel-arn <value>
--media-storage-configuration <value>
...
`--media-storage-configuration` (structure)
...
```
StreamARN=string,Status=string
```
