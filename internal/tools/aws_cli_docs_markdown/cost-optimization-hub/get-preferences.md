...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cost-optimization-hub/get-preferences.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cost-optimization-hub/get-preferences.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/GetPreferences)
...
Retrieves the status of the âsavings estimation modeâ preference.

memberAccountDiscountVisibility -> (string)

Retrieves the status of the âmember account discount visibilityâ preference.