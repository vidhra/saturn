# list-typed-link-facet-attributesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/list-typed-link-facet-attributes.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/list-typed-link-facet-attributes.html)*
...
`list-typed-link-facet-attributes` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
