...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudhsmv2/put-resource-policy.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudhsmv2/put-resource-policy.html)*
...
In order to share a backup, it must be in a âREADYâ state and you must own it.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/PutResourcePolicy)
