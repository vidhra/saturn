# start-organization-service-access-updateÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/start-organization-service-access-update.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/start-organization-service-access-update.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/networkmanager-2019-07-05/StartOrganizationServiceAccessUpdate)
...
The status of the organizationâs AWS service access. This will be `ENABLED` or `DISABLED` .
...
The current service-linked role (SLR) deployment status for an Amazon Web Services Organizationâs accounts. This will be either `SUCCEEDED` or `IN_PROGRESS` .
