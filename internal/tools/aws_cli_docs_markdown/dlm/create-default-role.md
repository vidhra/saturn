# create-default-roleÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dlm/create-default-role.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dlm/create-default-role.html)*
...
The resource type for which the role needs to be created. The available options are âsnapshotâ and âimageâ. This parameter defaults to âsnapshotâ.
