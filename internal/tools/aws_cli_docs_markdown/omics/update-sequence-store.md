# update-sequence-storeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/update-sequence-store.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/update-sequence-store.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/UpdateSequenceStore)
