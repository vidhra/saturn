# batch-delete-read-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/batch-delete-read-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/batch-delete-read-set.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/BatchDeleteReadSet)
...
The read setsâ sequence store ID.
