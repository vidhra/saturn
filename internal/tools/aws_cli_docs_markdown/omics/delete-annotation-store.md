# delete-annotation-storeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/delete-annotation-store.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/delete-annotation-store.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/DeleteAnnotationStore)
