# get-annotation-storeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/get-annotation-store.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/get-annotation-store.html)*
...
The storeâs annotation file format.
