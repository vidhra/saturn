# create-sequence-storeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/create-sequence-store.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/create-sequence-store.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/CreateSequenceStore)
...
To ensure that requests donât run multiple times, specify a unique token for each request.

`--fallback-location` (string)

An S3 location that is used to store files that have failed a direct upload.

`--e-tag-algorithm-family` (string)
...
`--propagated-set-level-tags` (list)
