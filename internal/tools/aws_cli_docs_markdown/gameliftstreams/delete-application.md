...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gameliftstreams/delete-application.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gameliftstreams/delete-application.html)*
...
- The application is in `READY` or `ERROR` status. You cannot delete an application thatâs in `PROCESSING` or `INITIALIZED` status.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/gameliftstreams-2018-05-10/DeleteApplication)
