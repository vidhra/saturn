...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/get-account-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/get-account-settings.html)*
...
Information about an AWS accountâs usage of free trial device minutes.
