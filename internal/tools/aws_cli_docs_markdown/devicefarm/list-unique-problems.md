# list-unique-problemsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-unique-problems.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-unique-problems.html)*
...
A message about the unique problemsâ result.
...
The problem detailâs ARN.

name -> (string)

The problem detailâs name.
...
A message about the problemâs result.
