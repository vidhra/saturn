...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-suites.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-suites.html)*
...
The jobâs Amazon Resource Name (ARN).
...
The suiteâs start time.

stopped -> (timestamp)

The suiteâs stop time.

counters -> (structure)

The suiteâs result counters.
...
A message about the suiteâs result.
