...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-artifacts.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-artifacts.html)*
...
The artifactâs file extension.

url -> (string)

The presigned Amazon S3 URL that can be used with a GET request to download the artifactâs file.
