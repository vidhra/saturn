# create-resource-groupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector/create-resource-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector/create-resource-group.html)*
...
A collection of keys and an array of possible values, â[{âkeyâ:âkey1â,âvaluesâ:[âValue1â,âValue2â]},{âkeyâ:âKey2â,âvaluesâ:[âValue3â]}]â.
