# register-cross-account-access-roleÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector/register-cross-account-access-role.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector/register-cross-account-access-role.html)*
...
For more information, see [Setting up Amazon Inspector](https://docs.aws.amazon.com/inspector/latest/userguide/inspector_settingup.html) in the *Amazon Inspector* guide.
