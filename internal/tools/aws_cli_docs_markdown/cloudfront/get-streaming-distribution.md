# get-streaming-distributionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/get-streaming-distribution.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/get-streaming-distribution.html)*
...
The current version of the streaming distributionâs information. For example: `E2QWRUHAPOMQZL` .