...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/transfer/list-host-keys.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/transfer/list-host-keys.html)*
...
Returns a list of host keys for the server thatâs specified by the `ServerId` parameter.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/transfer-2018-11-05/ListHostKeys)
...
Returns properties of the host key thatâs specified.
