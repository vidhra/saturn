...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/get-state-template.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/get-state-template.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iotfleetwise-2021-06-17/GetStateTemplate)
...
A list of vehicle attributes associated with the payload published on the state templateâs MQTT topic.
...
A list of vehicle attributes to associate with user properties of the messages published on the state templateâs MQTT topic.
