# get-register-account-statusÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/get-register-account-status.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/get-register-account-status.html)*
...
This API operation doesnât require input parameters.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iotfleetwise-2021-06-17/GetRegisterAccountStatus)
...
- `REGISTRATION_FAILURE` - Amazon Web Services IoT FleetWise canât register the AWS resource. Try again later.
