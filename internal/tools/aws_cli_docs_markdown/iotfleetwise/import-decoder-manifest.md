# import-decoder-manifestÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/import-decoder-manifest.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/import-decoder-manifest.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iotfleetwise-2021-06-17/ImportDecoderManifest)
...
```
canDbc={networkInterface=string,canDbcFiles=[blob,blob],signalsMap={KeyName1=string,KeyName2=string}} ...
```
