# describe-tape-archivesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-tape-archives.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-tape-archives.html)*
...
The default timestamp format is in the ISO8601 extended YYYY-MM-DDâTâHH:MM:SSâZâ format.
