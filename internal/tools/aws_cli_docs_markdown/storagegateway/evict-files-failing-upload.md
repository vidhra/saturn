# evict-files-failing-uploadÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/evict-files-failing-upload.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/evict-files-failing-upload.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/storagegateway-2013-06-30/EvictFilesFailingUpload)
...
`--force-remove` | `--no-force-remove` (boolean)
