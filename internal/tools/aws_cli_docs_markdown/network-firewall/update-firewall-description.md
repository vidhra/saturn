# update-firewall-descriptionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/network-firewall/update-firewall-description.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/network-firewall/update-firewall-description.html)*
...
Modifies the description for the specified firewall. Use the description to help you identify the firewall when youâre working with it.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/network-firewall-2020-11-12/UpdateFirewallDescription)
