...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lex-models/start-import.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lex-models/start-import.html)*
...
A list of tags to add to the imported bot. You can only add tags when you import a bot, you canât add tags to an intent or slot type.
