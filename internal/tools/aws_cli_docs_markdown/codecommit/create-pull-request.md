...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/create-pull-request.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/create-pull-request.html)*
...
The following `create-pull-request` example creates a pull request named âPronunciation difficulty analyzerâ with a description of âPlease review these changes by Tuesdayâ that targets the âjane-branchâ source branch and is to be merged to the default branch âmainâ in an AWS CodeCommit repository named âMyDemoRepoâ.
