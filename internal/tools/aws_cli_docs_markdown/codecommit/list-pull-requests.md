...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/list-pull-requests.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/list-pull-requests.html)*
...
This example demonstrates how to list pull requests created by an IAM user with the ARN âarn:aws:iam::111111111111:user/Li_Juanâ and the status of âCLOSEDâ in an AWS CodeCommit repository named âMyDemoRepoâ:
