...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/create-branch.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/create-branch.html)*
...
Calling the create branch operation does not set a repositoryâs default branch. To do this, call the update default branch operation.
