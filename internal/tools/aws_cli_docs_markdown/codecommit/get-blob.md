...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/get-blob.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/get-blob.html)*
...
The following `get-blob` example retrieves information about a Git blob with the ID of â2eb4af3bEXAMPLEâ in an AWS CodeCommit repository named âMyDemoRepoâ.
