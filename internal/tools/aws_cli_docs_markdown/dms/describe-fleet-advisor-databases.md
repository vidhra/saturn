# describe-fleet-advisor-databasesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/describe-fleet-advisor-databases.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/describe-fleet-advisor-databases.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DescribeFleetAdvisorDatabases)
...
Provides descriptions of the Fleet Advisor collector databases, including the databaseâs collector, ID, and name.
