# start-metadata-model-export-to-targetÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/start-metadata-model-export-to-target.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/start-metadata-model-export-to-target.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/StartMetadataModelExportToTarget)
...
`--overwrite-extension-pack` | `--no-overwrite-extension-pack` (boolean)
