# reload-replication-tablesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/reload-replication-tables.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/reload-replication-tables.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/ReloadReplicationTables)
