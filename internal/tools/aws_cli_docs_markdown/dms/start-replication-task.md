# start-replication-taskÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/start-replication-task.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/start-replication-task.html)*
...
The `resume-processing` option isnât applicable for a full-load task, because you canât resume partially loaded tables during the full load phase.
