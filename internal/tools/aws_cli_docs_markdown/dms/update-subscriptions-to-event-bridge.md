# update-subscriptions-to-event-bridgeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/update-subscriptions-to-event-bridge.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/update-subscriptions-to-event-bridge.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/UpdateSubscriptionsToEventBridge)
