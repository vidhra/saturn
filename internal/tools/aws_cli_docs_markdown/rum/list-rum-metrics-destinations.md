# list-rum-metrics-destinationsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rum/list-rum-metrics-destinations.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rum/list-rum-metrics-destinations.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/rum-2018-05-10/ListRumMetricsDestinations)

`list-rum-metrics-destinations` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
