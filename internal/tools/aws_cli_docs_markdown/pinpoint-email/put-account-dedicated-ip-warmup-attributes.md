# put-account-dedicated-ip-warmup-attributesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/put-account-dedicated-ip-warmup-attributes.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/put-account-dedicated-ip-warmup-attributes.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutAccountDedicatedIpWarmupAttributes)
...
`--auto-warmup-enabled` | `--no-auto-warmup-enabled` (boolean)
