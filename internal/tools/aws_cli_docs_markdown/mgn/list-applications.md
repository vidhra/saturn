...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-applications.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-applications.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/ListApplications)
...
```
applicationIDs=string,string,isArchived=boolean,waveIDs=string,string
```
...
applicationAggregatedStatus -> (structure)
