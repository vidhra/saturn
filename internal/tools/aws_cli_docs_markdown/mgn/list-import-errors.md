...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-import-errors.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-import-errors.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/ListImportErrors)

`list-import-errors` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
