# put-template-actionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/put-template-action.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/put-template-action.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/PutTemplateAction)
