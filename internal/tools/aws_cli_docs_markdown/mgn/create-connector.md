...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/create-connector.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/create-connector.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/CreateConnector)
...
```
cloudWatchLogGroupName=string,cloudWatchOutputEnabled=boolean,outputS3BucketName=string,s3OutputEnabled=boolean
```
