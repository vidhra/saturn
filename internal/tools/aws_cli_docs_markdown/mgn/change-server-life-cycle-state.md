# change-server-life-cycle-stateÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/change-server-life-cycle-state.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/change-server-life-cycle-state.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/ChangeServerLifeCycleState)
