# start-data-quality-ruleset-evaluation-runÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/start-data-quality-ruleset-evaluation-run.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/start-data-quality-ruleset-evaluation-run.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/StartDataQualityRulesetEvaluationRun)
