# get-column-statistics-task-runÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/get-column-statistics-task-run.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/get-column-statistics-task-run.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetColumnStatisticsTaskRun)
...
`--column-statistics-task-run-id` (string)
