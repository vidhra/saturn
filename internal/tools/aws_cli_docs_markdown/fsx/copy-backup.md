...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/copy-backup.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/copy-backup.html)*
...
You can use the `SourceRegion` parameter to specify the Amazon Web Services Region from which the backup will be copied. For example, if you make the call from the `us-west-1` Region and want to copy a backup from the `us-east-2` Region, you specify `us-east-2` in the `SourceRegion` parameter to make a cross-Region copy. If you donât specify a Region, the backup copy is created in the same Region where the request is sent from (in-Region copy).
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/CopyBackup)
...
The ID of the source backup. Specifies the ID of the backup thatâs being copied.

`--source-region` (string)

The source Amazon Web Services Region of the backup. Specifies the Amazon Web Services Region from which the backup is being copied. The source and destination Regions must be in the same Amazon Web Services partition. If you donât specify a Region, `SourceRegion` defaults to the Region where the request is sent from (in-Region copy).
...
Specifies the resource type thatâs backed up.
