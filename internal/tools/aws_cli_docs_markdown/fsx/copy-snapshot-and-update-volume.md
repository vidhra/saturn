# copy-snapshot-and-update-volumeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/copy-snapshot-and-update-volume.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/copy-snapshot-and-update-volume.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/CopySnapshotAndUpdateVolume)
...
- `INCREMENTAL_COPY` - Copies only the snapshot data thatâs changed since the previous replication.

### Note

`CLONE` isnât a valid copy strategy option for the `CopySnapshotAndUpdateVolume` operation.
...
Confirms that you want to delete data on the destination volume that wasnât there during the previous snapshot replication.

Your replication will fail if you donât include an option for a specific type of data and that data is on your destination. For example, if you donât include `DELETE_INTERMEDIATE_SNAPSHOTS` and there are intermediate snapshots on the destination, you canât copy the snapshot.

- `DELETE_INTERMEDIATE_SNAPSHOTS` - Deletes snapshots on the destination volume that arenât on the source volume.
- `DELETE_CLONED_VOLUMES` - Deletes snapshot clones on the destination volume that arenât on the source volume.
- `DELETE_INTERMEDIATE_DATA` - Overwrites snapshots on the destination volume that donât match the source snapshot that youâre copying.
