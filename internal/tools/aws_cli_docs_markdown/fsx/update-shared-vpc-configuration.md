# update-shared-vpc-configurationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/update-shared-vpc-configuration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/update-shared-vpc-configuration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/UpdateSharedVpcConfiguration)
...
`--enable-fsx-route-table-updates-from-participant-accounts` (string)
