...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/delete-file-cache.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fsx/delete-file-cache.html)*
...
The data in a deleted cache is also deleted and canât be recovered by any means.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/DeleteFileCache)
...
The ID of the cache thatâs being deleted.
