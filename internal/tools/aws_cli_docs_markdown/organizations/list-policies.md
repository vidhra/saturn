...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-policies.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-policies.html)*
...
A list of policies that match the filter criteria in the request. The output list doesnât include the policy contents. To see the content for a policy, see  DescribePolicy .
