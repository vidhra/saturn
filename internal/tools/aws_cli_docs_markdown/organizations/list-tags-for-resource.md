...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-tags-for-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-tags-for-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/organizations-2016-11-28/ListTagsForResource)
...
- Organizational unit â specify the OU ID that begins with `ou-` and looks similar to: [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-tags-for-resource.html#id1)ou-*1a2b-34uvwxyz* ``
- Root â specify the root ID that begins with `r-` and looks similar to: [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-tags-for-resource.html#id3)r-*1a2b* ``
- Policy â specify the policy ID that begins with `p-` andlooks similar to: [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-tags-for-resource.html#id5)p-*12abcdefg3* ``
