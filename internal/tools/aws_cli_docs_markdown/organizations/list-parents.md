...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-parents.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-parents.html)*
...
The unique identifier (ID) of the OU or account whose parent containers you want to list. Donât specify a root.
