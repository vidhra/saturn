# update-organizational-unitÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/update-organizational-unit.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/update-organizational-unit.html)*
...
Renames the specified organizational unit (OU). The ID and ARN donât change. The child OUs and accounts remain in place, and any attached policies of the OU remain attached.
...
This example shows you how to rename an OU: In this example, the OU is renamed âAccountingOUâ:
