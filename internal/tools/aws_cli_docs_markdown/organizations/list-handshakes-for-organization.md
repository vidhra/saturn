# list-handshakes-for-organizationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-handshakes-for-organization.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-handshakes-for-organization.html)*
...
The output shows two handshakes. The first one is an invitation to Juanâs account and shows a state of OPEN. The second is an invitation to Anikaâs account and shows a state of ACCEPTED:
