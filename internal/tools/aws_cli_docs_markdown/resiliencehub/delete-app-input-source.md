# delete-app-input-sourceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/delete-app-input-source.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/delete-app-input-source.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/resiliencehub-2020-04-30/DeleteAppInputSource)
...
The imported Terraform s3 state ï¬le you want to remove from the Resilience Hub application.
