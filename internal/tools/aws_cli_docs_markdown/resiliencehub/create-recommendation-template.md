# create-recommendation-templateÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/create-recommendation-template.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/create-recommendation-template.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/resiliencehub-2020-04-30/CreateRecommendationTemplate)
...
The newly created recommendation template, returned as an object. This object includes the templateâs name, format, status, tags, Amazon S3 bucket location, and more.
