# create-address-listÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mailmanager/create-address-list.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mailmanager/create-address-list.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mailmanager-2023-10-17/CreateAddressList)

## Synopsis

```
create-address-list
--address-list-name <value>
[--client-token <value>]
[--tags <value>]
