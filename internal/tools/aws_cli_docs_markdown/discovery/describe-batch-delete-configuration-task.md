# describe-batch-delete-configuration-taskÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/discovery/describe-batch-delete-configuration-task.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/discovery/describe-batch-delete-configuration-task.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/discovery-2015-11-01/DescribeBatchDeleteConfigurationTask)
...
The deletion taskâs unique identifier.
