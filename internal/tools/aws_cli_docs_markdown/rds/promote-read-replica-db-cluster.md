...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/promote-read-replica-db-cluster.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/promote-read-replica-db-cluster.html)*
...
The identifier of the DB cluster read replica to promote. This parameter isnât case-sensitive.
