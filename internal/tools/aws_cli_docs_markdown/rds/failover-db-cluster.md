...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/failover-db-cluster.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/failover-db-cluster.html)*
...
The identifier of the DB cluster to force a failover for. This parameter isnât case-sensitive.
...
This setting isnât supported for RDS for MySQL Multi-AZ DB clusters.
