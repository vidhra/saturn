# enable-http-endpointÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/enable-http-endpoint.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/enable-http-endpoint.html)*
...
Enables the HTTP endpoint for the DB cluster. By default, the HTTP endpoint isnât enabled.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/rds-2014-10-31/EnableHttpEndpoint)
