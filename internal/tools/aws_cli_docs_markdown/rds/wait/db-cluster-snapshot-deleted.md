# db-cluster-snapshot-deletedÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/wait/db-cluster-snapshot-deleted.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/wait/db-cluster-snapshot-deleted.html)*
...
`db-cluster-snapshot-deleted` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
