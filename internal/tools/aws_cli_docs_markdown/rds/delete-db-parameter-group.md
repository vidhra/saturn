...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-parameter-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-parameter-group.html)*
...
Deletes a specified DB parameter group. The DB parameter group to be deleted canât be associated with any DB instances.
