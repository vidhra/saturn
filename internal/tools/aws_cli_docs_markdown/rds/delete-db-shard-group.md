# delete-db-shard-groupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-shard-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-shard-group.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/rds-2014-10-31/DeleteDBShardGroup)
...
The following `delete-db-shard-group` example deletes a DB shard group after youâve deleted all of your databases and schemas, including the `public` schema.
