...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opensearch/associate-package.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opensearch/associate-package.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/AssociatePackage)
...
`--prerequisite-package-id-list` (list)
...
`--association-configuration` (structure)
