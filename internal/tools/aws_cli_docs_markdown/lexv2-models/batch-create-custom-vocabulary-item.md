# batch-create-custom-vocabulary-itemÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lexv2-models/batch-create-custom-vocabulary-item.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lexv2-models/batch-create-custom-vocabulary-item.html)*
...
Create a batch of custom vocabulary items for a given bot localeâs custom vocabulary.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/BatchCreateCustomVocabularyItem)
