...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lexv2-models/create-bot.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lexv2-models/create-bot.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/CreateBot)
...
A list of tags to add to the bot. You can only add tags when you create a bot. You canât use the `UpdateBot` operation to update tags. To update tags, use the `TagResource` operation.
...
A list of tags to add to the test alias for a bot. You can only add tags when you create a bot. You canât use the `UpdateAlias` operation to update tags. To update tags on the test alias, use the `TagResource` operation.
