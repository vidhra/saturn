# list-bot-resource-generationsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lexv2-models/list-bot-resource-generations.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lexv2-models/list-bot-resource-generations.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/ListBotResourceGenerations)
...
- `creationStartTime` â The time at which the generation request was created.
- `lastUpdatedTime` â The time at which the generation request was last updated.
