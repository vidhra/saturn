# start-trace-retrievalÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/start-trace-retrieval.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/start-trace-retrieval.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/StartTraceRetrieval)
