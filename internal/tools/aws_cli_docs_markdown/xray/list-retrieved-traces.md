# list-retrieved-tracesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/list-retrieved-traces.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/list-retrieved-traces.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/ListRetrievedTraces)
