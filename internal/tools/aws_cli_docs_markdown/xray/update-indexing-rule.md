# update-indexing-ruleÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/update-indexing-rule.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/update-indexing-rule.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/UpdateIndexingRule)
...
This is a Tagged Union structure. Only one of the following top level keys can be set: `Probabilistic`.
...
```
Probabilistic={DesiredSamplingPercentage=double}
```
