# describe-node-association-statusÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks-cm/describe-node-association-status.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks-cm/describe-node-association-status.html)*
...
For more information, see [DescribeNodeAssociationStatus](http://docs.aws.amazon.com/opsworks-cm/latest/APIReference/API_DescribeNodeAssociationStatus.html) in the *AWS OpsWorks for Chef Automate API Reference*.
