...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks-cm/describe-account-attributes.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks-cm/describe-account-attributes.html)*
...
accountâs usage of AWS OpsWorks for Chef Automate resources.:
...
For more information, see [DescribeAccountAttributes](http://docs.aws.amazon.com/opsworks-cm/latest/APIReference/API_DescribeAccountAttributes.html) in the *AWS OpsWorks for Chef Automate API Reference*.
