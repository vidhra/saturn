...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/admin-enable-user.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/admin-enable-user.html)*
...
The following `admin-enable-user` example enables sign-in by the user [diego@example.com](mailto:diego%40example.com).
