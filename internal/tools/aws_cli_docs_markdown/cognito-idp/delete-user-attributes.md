# delete-user-attributesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/delete-user-attributes.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/delete-user-attributes.html)*
...
The following `delete-user-attributes` example deletes the custom attribute âcustom:attributeâ from the currently signed-in user.
