...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/list-groups.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/list-groups.html)*
...
An array of groups and their details. Each entry thatâs returned includes description, precedence, and IAM role values.
