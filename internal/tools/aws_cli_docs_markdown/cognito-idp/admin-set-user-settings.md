# admin-set-user-settingsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/admin-set-user-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/admin-set-user-settings.html)*
...
*This action is no longer supported.* You can use it to configure only SMS MFA. You canât use it to configure time-based one-time password (TOTP) software token MFA.
...
The ID of the user pool that contains the user whose options youâre setting.
...
This example sets the MFA delivery preference for username [diego@example.com](mailto:diego%40example.com) to EMAIL.
