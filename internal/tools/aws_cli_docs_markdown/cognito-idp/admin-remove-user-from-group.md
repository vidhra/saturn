# admin-remove-user-from-groupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/admin-remove-user-from-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/admin-remove-user-from-group.html)*
...
This example removes [jane@example.com](mailto:jane%40example.com) from SampleGroup.
