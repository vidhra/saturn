...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/set-user-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/set-user-settings.html)*
...
*This action is no longer supported.* You can use it to configure only SMS MFA. You canât use it to configure time-based one-time password (TOTP) software token or email MFA.
