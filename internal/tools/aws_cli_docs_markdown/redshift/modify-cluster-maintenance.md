# modify-cluster-maintenanceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/modify-cluster-maintenance.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/modify-cluster-maintenance.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/ModifyClusterMaintenance)
...
`--defer-maintenance` | `--no-defer-maintenance` (boolean)

A boolean indicating whether to enable the deferred maintenance window.

`--defer-maintenance-identifier` (string)

A unique identifier for the deferred maintenance window.

`--defer-maintenance-start-time` (timestamp)

A timestamp indicating the start time for the deferred maintenance window.

`--defer-maintenance-end-time` (timestamp)

A timestamp indicating end time for the deferred maintenance window. If you specify an end time, you canât specify a duration.

`--defer-maintenance-duration` (integer)

An integer indicating the duration of the maintenance window in days. If you specify a duration, you canât specify an end time. The duration must be 45 days or less.
