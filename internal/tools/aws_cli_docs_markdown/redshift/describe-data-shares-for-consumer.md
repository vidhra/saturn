# describe-data-shares-for-consumerÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/describe-data-shares-for-consumer.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/describe-data-shares-for-consumer.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/DescribeDataSharesForConsumer)

`describe-data-shares-for-consumer` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
