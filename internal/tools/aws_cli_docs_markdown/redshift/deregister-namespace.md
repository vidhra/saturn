# deregister-namespaceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/deregister-namespace.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/deregister-namespace.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/DeregisterNamespace)
...
`--namespace-identifier` (tagged union structure)
...
ServerlessIdentifier -> (structure)
...
ProvisionedIdentifier -> (structure)
...
```
ServerlessIdentifier={NamespaceIdentifier=string,WorkgroupIdentifier=string},ProvisionedIdentifier={ClusterIdentifier=string}
```
