...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-clusters.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-clusters.html)*
...
Indicates whether external clusters are included in the returned list. Use â`all` â to return [https://docs.aws.amazon.com/eks/latest/userguide/eks-connector.html](https://docs.aws.amazon.com/eks/latest/userguide/eks-connector.html) connected clusters, or blank to return only Amazon EKS clusters. â`all` â must be in lowercase otherwise an error occurs.
