...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/archive-findings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/archive-findings.html)*
...
Only the administrator account can archive findings. Member accounts donât have permission to archive findings from their accounts.
