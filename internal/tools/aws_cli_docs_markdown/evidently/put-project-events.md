...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/evidently/put-project-events.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/evidently/put-project-events.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/evidently-2021-02-01/PutProjectEvents)
...
A structure that contains Evidentlyâs response to the sent events, including an event ID and error codes, if any.
