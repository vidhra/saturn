# list-workflow-step-executionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/list-workflow-step-executions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/list-workflow-step-executions.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/imagebuilder-2019-12-02/ListWorkflowStepExecutions)
...
The image build version resource ARN thatâs associated with the specified runtime instance of the workflow.
