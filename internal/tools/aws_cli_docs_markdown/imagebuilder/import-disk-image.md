...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/import-disk-image.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/import-disk-image.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/imagebuilder-2019-12-02/ImportDiskImage)
...
The name of the image resource thatâs created from the import.

`--semantic-version` (string)

The semantic version to attach to the image thatâs created during the import process. This version follows the semantic version syntax.
...
The Amazon Resource Name (ARN) of the infrastructure configuration resource thatâs used for launching the EC2 instance on which the ISO image is built.

`--uri` (string)

The `uri` of the ISO disk file thatâs stored in Amazon S3.
