...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/get-workflow.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/get-workflow.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/imagebuilder-2019-12-02/GetWorkflow)
...
`--workflow-build-version-arn` (string)
...
Defines a parameter thatâs used to provide configuration details for the workflow.
