# create-application-instanceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/panorama/create-application-instance.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/panorama/create-application-instance.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/panorama-2019-07-24/CreateApplicationInstance)
...
`--manifest-overrides-payload` (tagged union structure)
...
`--manifest-payload` (tagged union structure)

The applicationâs manifest document.
