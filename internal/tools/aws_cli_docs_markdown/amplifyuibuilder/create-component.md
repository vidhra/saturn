...
The data binding information for the componentâs properties.
...
The data binding configuration for customizing a componentâs properties. Use this for a collection component.
