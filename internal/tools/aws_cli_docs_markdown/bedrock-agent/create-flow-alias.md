...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent/create-flow-alias.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent/create-flow-alias.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-2023-06-05/CreateFlowAlias)
...
create-flow-alias
[--client-token <value>]
[--concurrency-configuration <value>]
[--description <value>]
...
`--concurrency-configuration` (structure)
...
```
maxConcurrency=integer,type=string
```
