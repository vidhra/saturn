...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/entityresolution/get-id-mapping-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/entityresolution/get-id-mapping-job.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/entityresolution-2018-05-10/GetIdMappingJob)
...
The number of records remaining after loading and aggregating duplicate records. Duplicates are determined by the field marked as UNIQUE_ID in your schema mapping - records sharing the same value in this field are considered duplicates. For example, if you specified âcustomer_idâ as a UNIQUE_ID field and had three records with the same customer_id value, they would count as one unique record in this metric.
