...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/delete-time-series.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/delete-time-series.html)*
...
Deletes a time series (data stream). If you delete a time series thatâs associated with an asset property, the asset property still exists, but the time series will no longer be associated with this asset property.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/DeleteTimeSeries)
