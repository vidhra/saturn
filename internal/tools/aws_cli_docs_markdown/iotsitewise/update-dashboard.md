...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/update-dashboard.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/update-dashboard.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/UpdateDashboard)
...
The following `update-dashboard` example changes the title of a dashboardâs line chart that displays total generated power for a wind farm.
