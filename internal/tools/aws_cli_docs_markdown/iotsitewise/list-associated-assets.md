# list-associated-assetsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/list-associated-assets.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/list-associated-assets.html)*
...
- `PARENT` - List the assetâs parent asset.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/ListAssociatedAssets)

`list-associated-assets` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
...
(Optional) If you donât provide a `hierarchyId` , all the immediate assets in the `traversalDirection` will be returned.
...
- `CHILD` â The list includes all child assets associated to the asset.
- `PARENT` â The list includes the assetâs parent asset.
