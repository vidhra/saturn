# create-mission-profileÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/groundstation/create-mission-profile.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/groundstation/create-mission-profile.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/CreateMissionProfile)
...
Amount of time after a contact ends that youâd like to receive a Ground Station Contact State Change event indicating the pass has finished.

`--contact-pre-pass-duration-seconds` (integer)

Amount of time prior to contact start youâd like to receive a Ground Station Contact State Change event indicating an upcoming pass.
...
Smallest amount of time in seconds that youâd like to see for an available contact. AWS Ground Station will not present you with contacts shorter than this duration.
