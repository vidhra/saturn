# get-v2-logging-optionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/get-v2-logging-options.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/get-v2-logging-options.html)*
...
For more information, see [title](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/link) in the *AWS IoT Developer Guide*.
