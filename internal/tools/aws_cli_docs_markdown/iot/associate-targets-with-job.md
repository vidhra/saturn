# associate-targets-with-jobÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/associate-targets-with-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/associate-targets-with-job.html)*
...
- The job must have been created with the `targetSelection` field set to âCONTINUOUSâ.
- The job status must currently be âIN_PROGRESSâ.
