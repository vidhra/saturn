...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-package.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-package.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/CreatePackage)
...
A summary of the package being created. This can be used to outline the packageâs contents or purpose.
