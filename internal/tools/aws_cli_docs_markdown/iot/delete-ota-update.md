...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-ota-update.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-ota-update.html)*
...
When true, deletes the IoT job created by the OTAUpdate process even if it is âIN_PROGRESSâ. Otherwise, if the job is not in a terminal state (âCOMPLETEDâ or âCANCELEDâ) an exception will occur. The default is false.
