# deprecate-thing-typeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/deprecate-thing-type.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/deprecate-thing-type.html)*
...
The following `deprecate-thing-type` example deprecates a thing type so that users canât associate any new things with it.
