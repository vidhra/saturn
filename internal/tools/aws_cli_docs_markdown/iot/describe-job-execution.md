# describe-job-executionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-job-execution.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-job-execution.html)*
...
A string (consisting of the digits â0â through â9â which is used to specify a particular job execution on a particular device.
...
A string (consisting of the digits â0â through â9â) which identifies this particular job execution on this particular device. It can be used in commands which return or update job execution information.
