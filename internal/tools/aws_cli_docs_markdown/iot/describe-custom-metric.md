# describe-custom-metricÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-custom-metric.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-custom-metric.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/DescribeCustomMetric)
...
Field represents a friendly name in the console for the custom metric; doesnât have to be unique. Donât use this name as the metric identifier in the device metric report. Can be updated.
