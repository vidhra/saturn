# describe-certificate-providerÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-certificate-provider.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-certificate-provider.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/DescribeCertificateProvider)
...
The Lambda function ARN thatâs associated with the certificate provider.
