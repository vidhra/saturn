# create-scheduled-auditÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-scheduled-audit.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-scheduled-audit.html)*
...
The day of the month on which the scheduled audit takes place. This can be â1â through â31â or âLASTâ. This field is required if the âfrequencyâ parameter is set to `MONTHLY` . If days 29 to 31 are specified, and the month doesnât have that many days, the audit takes place on the `LAST` day of the month.
