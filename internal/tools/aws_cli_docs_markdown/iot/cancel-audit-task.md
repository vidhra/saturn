...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/cancel-audit-task.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/cancel-audit-task.html)*
...
Cancels an audit that is in progress. The audit can be either scheduled or on demand. If the audit isnât in progress, an âInvalidRequestExceptionâ occurs.
...
The ID of the audit you want to cancel. You can only cancel an audit that is âIN_PROGRESSâ.
