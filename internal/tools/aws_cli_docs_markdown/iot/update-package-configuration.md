# update-package-configurationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/update-package-configuration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/update-package-configuration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/UpdatePackageConfiguration)
...
`--version-update-by-jobs-config` (structure)

Configuration to manage jobâs package version reporting. This updates the thingâs reserved named shadow that the job targets.
