...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/tag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/tag-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/synthetics-2017-10-11/TagResource)
...
The ARN of the canary or group that youâre adding tags to.

The ARN format of a canary is [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/tag-resource.html#id1)arn:aws:synthetics:*Region* :*account-id* :canary:*canary-name* `` .

The ARN format of a group is [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/tag-resource.html#id3)arn:aws:synthetics:*Region* :*account-id* :group:*group-name* ``
