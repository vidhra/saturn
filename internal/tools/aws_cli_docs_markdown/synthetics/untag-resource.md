...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/untag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/untag-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/synthetics-2017-10-11/UntagResource)
...
The ARN of the canary or group that youâre removing tags from.

The ARN format of a canary is [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/untag-resource.html#id1)arn:aws:synthetics:*Region* :*account-id* :canary:*canary-name* `` .

The ARN format of a group is [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/untag-resource.html#id3)arn:aws:synthetics:*Region* :*account-id* :group:*group-name* ``
