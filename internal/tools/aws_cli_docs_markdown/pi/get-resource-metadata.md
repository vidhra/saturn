# get-resource-metadataÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pi/get-resource-metadata.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pi/get-resource-metadata.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/pi-2018-02-27/GetResourceMetadata)
...
- `UNSUPPORTED` - The feature isnât supported on the instance.
...
- `UNKNOWN` - The feature status couldnât be determined.