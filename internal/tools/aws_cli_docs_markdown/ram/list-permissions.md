...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/list-permissions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/list-permissions.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ram-2018-01-04/ListPermissions)
...
- `AWS` â returns only Amazon Web Services managed permissions.
- `LOCAL` â returns only customer managed permissions
- `ALL` â returns both Amazon Web Services managed permissions and customer managed permissions.

If you donât specify this parameter, the default is `All` .
