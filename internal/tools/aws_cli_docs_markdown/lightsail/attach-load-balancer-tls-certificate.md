# attach-load-balancer-tls-certificateÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/attach-load-balancer-tls-certificate.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/attach-load-balancer-tls-certificate.html)*
...
These SSL/TLS certificates are only usable by Lightsail load balancers. You canât get the certificate and use it for another purpose.
