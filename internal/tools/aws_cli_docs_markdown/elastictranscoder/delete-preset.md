...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elastictranscoder/delete-preset.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elastictranscoder/delete-preset.html)*
...
The DeletePreset operation removes a preset that youâve added in an AWS region.

### Note

You canât delete the default presets that are included with Elastic Transcoder.
