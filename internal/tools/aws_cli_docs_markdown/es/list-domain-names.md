...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/list-domain-names.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/list-domain-names.html)*
...
Returns the name of all Elasticsearch domains owned by the current userâs account.
...
Optional parameter to filter the output by domain engine type. Acceptable values are âElasticsearchâ and âOpenSearchâ.
