...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/list-vpc-endpoints-for-domain.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/list-vpc-endpoints-for-domain.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/es-2015-01-01/ListVpcEndpointsForDomain)
