# delete-outbound-cross-cluster-search-connectionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/delete-outbound-cross-cluster-search-connection.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/delete-outbound-cross-cluster-search-connection.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/es-2015-01-01/DeleteOutboundCrossClusterSearchConnection)
