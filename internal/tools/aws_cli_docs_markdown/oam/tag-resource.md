...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/tag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/tag-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/oam-2022-06-10/TagResource)
...
The ARN format of a sink is [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/tag-resource.html#id1)arn:aws:oam:*Region* :*account-id* :sink/*sink-id* ``

The ARN format of a link is [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/tag-resource.html#id3)arn:aws:oam:*Region* :*account-id* :link/*link-id* ``
