...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/list-sinks.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/list-sinks.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/oam-2022-06-10/ListSinks)

`list-sinks` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
...
A structure that contains information about one of this monitoring accountâs sinks.
