...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/create-sink.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/oam/create-sink.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/oam-2022-06-10/CreateSink)
