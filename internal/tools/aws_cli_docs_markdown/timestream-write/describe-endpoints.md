...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-write/describe-endpoints.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-write/describe-endpoints.html)*
...
Because the Timestream SDKs are designed to transparently work with the serviceâs architecture, including the management and mapping of the service endpoints, *we donât recommend that you use this API operation unless* :
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/timestream-write-2018-11-01/DescribeEndpoints)
