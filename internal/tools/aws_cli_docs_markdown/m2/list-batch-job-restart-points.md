# list-batch-job-restart-pointsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/list-batch-job-restart-points.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/list-batch-job-restart-points.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/ListBatchJobRestartPoints)
...
The Amazon Web Services Secrets Manager containing userâs credentials for authentication and authorization for List Batch Job Restart Points operation.
