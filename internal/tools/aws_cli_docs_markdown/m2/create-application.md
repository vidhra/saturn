...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/create-application.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/create-application.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/CreateApplication)
...
A client token is a unique, case-sensitive string of up to 128 ASCII characters with ASCII values of 33-126 inclusive. Itâs generated by the client to ensure idempotent operations, allowing for safe retries without unintended side effects.
