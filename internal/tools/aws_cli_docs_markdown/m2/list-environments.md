...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/list-environments.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/list-environments.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/ListEnvironments)
...
A pagination token thatâs returned when the response doesnât contain all the runtime environments.