...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sqs/list-queues.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sqs/list-queues.html)*
...
This example lists only queues that start with âMyâ.
