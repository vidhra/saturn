...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/migrationhubstrategy/start-assessment.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/migrationhubstrategy/start-assessment.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/migrationhubstrategy-2020-02-19/StartAssessment)

## Synopsis

```
start-assessment
[--assessment-data-source-type <value>]
[--assessment-targets <value>]
[--s3bucket-for-analysis-data <value>]
...
`--assessment-data-source-type` (string)
...
```
condition=string,name=string,values=string,string ...
```
...
`--s3bucket-for-analysis-data` (string)
