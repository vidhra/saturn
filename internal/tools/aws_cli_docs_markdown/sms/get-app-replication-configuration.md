# get-app-replication-configurationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/get-app-replication-configuration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/get-app-replication-configuration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetAppReplicationConfiguration)
...
If encrypted is enabled but a KMS key ID is not specified, the customerâs default KMS key for Amazon EBS is used.