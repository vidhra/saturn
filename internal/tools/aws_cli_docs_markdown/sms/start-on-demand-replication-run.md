# start-on-demand-replication-runÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/start-on-demand-replication-run.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/start-on-demand-replication-run.html)*
