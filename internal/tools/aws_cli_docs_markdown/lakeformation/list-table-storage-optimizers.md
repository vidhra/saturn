# list-table-storage-optimizersÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lakeformation/list-table-storage-optimizers.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lakeformation/list-table-storage-optimizers.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/lakeformation-2017-03-31/ListTableStorageOptimizers)
...
When an acceleration result has a disabled status, the message describes an error or simply indicates âdisabled by the userâ.
