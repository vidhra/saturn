# assume-decorated-role-with-samlÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lakeformation/assume-decorated-role-with-saml.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lakeformation/assume-decorated-role-with-saml.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/lakeformation-2017-03-31/AssumeDecoratedRoleWithSAML)
