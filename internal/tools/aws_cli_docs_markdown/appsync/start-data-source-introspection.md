# start-data-source-introspectionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/start-data-source-introspection.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/start-data-source-introspection.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/appsync-2017-07-25/StartDataSourceIntrospection)
...
```
resourceArn=string,secretArn=string,databaseName=string
```
