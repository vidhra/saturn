# associate-merged-graphql-apiÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/associate-merged-graphql-api.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/associate-merged-graphql-api.html)*
...
Creates an association between a Merged API and source API using the source APIâs identifier.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/appsync-2017-07-25/AssociateMergedGraphqlApi)
