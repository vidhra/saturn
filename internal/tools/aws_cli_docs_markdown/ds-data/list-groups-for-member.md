# list-groups-for-memberÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds-data/list-groups-for-member.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds-data/list-groups-for-member.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/directory-service-data-2023-05-31/ListGroupsForMember)

`list-groups-for-member` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
...
The identifier (ID) of the directory thatâs associated with the member.

`--member-realm` (string)

The domain name thatâs associated with the group member.
...
The `SAMAccountName` of the user, group, or computer thatâs a member of the group.
...
**To list a directoryâs group membership**
...
The domain thatâs associated with the member.
