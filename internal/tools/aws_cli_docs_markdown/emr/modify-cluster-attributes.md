# modify-cluster-attributesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/modify-cluster-attributes.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/modify-cluster-attributes.html)*
...
Modifies the cluster attributes âvisible-to-all-usersâ,  âtermination-protectedâ and âunhealthy-node-replacementâ.
...
Set Unhealthy Node Replacement on or off
