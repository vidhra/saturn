# create-persistent-app-uiÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/create-persistent-app-ui.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/create-persistent-app-ui.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/elasticmapreduce-2009-03-31/CreatePersistentAppUI)

## Synopsis

```
create-persistent-app-ui
--target-resource-arn <value>
[--emr-containers-config <value>]
[--tags <value>]
[--x-referer <value>]
[--profiler-type <value>]
