...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/stop-stream.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/stop-stream.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/StopStream)
