...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/delete-channel.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/delete-channel.html)*
...
If you try to delete a live channel, you will get an error (409 ConflictException). To delete a channel that is live, call  StopStream , wait for the Amazon EventBridge âStream Endâ event (to verify that the streamâs state is no longer Live), then call DeleteChannel. (See [Using EventBridge with Amazon IVS](https://docs.aws.amazon.com/ivs/latest/userguide/eventbridge.html) .)

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/DeleteChannel)
