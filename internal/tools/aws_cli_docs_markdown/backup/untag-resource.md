...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/untag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/untag-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/UntagResource)
