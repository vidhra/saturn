# delete-recovery-pointÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-recovery-point.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-recovery-point.html)*
...
When an IAM roleâs permissions are insufficient to call this API, the service sends back an HTTP 200 response with an empty HTTP body, but the recovery point is not deleted. Instead, it enters an `EXPIRED` state.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DeleteRecoveryPoint)
