# put-restore-validation-resultÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/put-restore-validation-result.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/put-restore-validation-result.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/PutRestoreValidationResult)
...
`--validation-status-message` (string)
