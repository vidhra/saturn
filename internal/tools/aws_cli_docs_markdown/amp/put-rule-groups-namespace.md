# put-rule-groups-namespaceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amp/put-rule-groups-namespace.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amp/put-rule-groups-namespace.html)*
...
You canât use this operation to add tags to an existing rule groups namespace. Instead, use `TagResource` .

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/amp-2020-08-01/PutRuleGroupsNamespace)
