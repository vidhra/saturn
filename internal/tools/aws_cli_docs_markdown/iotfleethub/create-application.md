...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleethub/create-application.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleethub/create-application.html)*
...
The name of the role must be in the form [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleethub/create-application.html#id1)AWSIotFleetHub_*random_string* `` .
