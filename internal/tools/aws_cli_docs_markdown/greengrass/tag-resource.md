...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/tag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/tag-resource.html)*
...
Adds tags to a Greengrass resource. Valid resources are âGroupâ, âConnectorDefinitionâ, âCoreDefinitionâ, âDeviceDefinitionâ, âFunctionDefinitionâ, âLoggerDefinitionâ, âSubscriptionDefinitionâ, âResourceDefinitionâ, and âBulkDeploymentâ.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/greengrass-2017-06-07/TagResource)
