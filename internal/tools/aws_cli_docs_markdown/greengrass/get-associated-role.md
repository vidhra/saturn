# get-associated-roleÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/get-associated-role.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/get-associated-role.html)*
...
The following `get-associated-role` example gets the IAM role thatâs associated with the specified Greengrass group. The group role is used by local Lambda functions and connectors to access AWS services.
