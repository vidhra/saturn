# stop-bulk-deploymentÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/stop-bulk-deployment.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/stop-bulk-deployment.html)*
...
Stops the execution of a bulk deployment. This action returns a status of ââStoppingââ until the deployment is stopped. You cannot start a new bulk deployment while a previous deployment is in the ââStoppingââ state. This action doesnât rollback completed deployments or cancel pending deployments.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/greengrass-2017-06-07/StopBulkDeployment)
