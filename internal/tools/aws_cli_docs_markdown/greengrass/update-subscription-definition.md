# update-subscription-definitionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/update-subscription-definition.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/update-subscription-definition.html)*
...
For more information, see [title](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/link) in the *guide*.
