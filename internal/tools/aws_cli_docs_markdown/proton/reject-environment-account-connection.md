# reject-environment-account-connectionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/reject-environment-account-connection.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/reject-environment-account-connection.html)*
...
After you reject an environment account connection request, you *canât* accept or use the rejected environment account connection.

You *canât* reject an environment account connection thatâs connected to an environment.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/RejectEnvironmentAccountConnection)
...
The environment connection account detail data thatâs returned by Proton.
