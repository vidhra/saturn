# update-environment-account-connectionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/update-environment-account-connection.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/update-environment-account-connection.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/UpdateEnvironmentAccountConnection)
...
The Amazon Resource Name (ARN) of the IAM service role thatâs associated with the environment account connection to update.
