# accept-environment-account-connectionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/accept-environment-account-connection.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/accept-environment-account-connection.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/AcceptEnvironmentAccountConnection)
...
The environment account connection data thatâs returned by Proton.
