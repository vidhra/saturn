# create-environment-template-versionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/create-environment-template-version.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/create-environment-template-version.html)*
...
Create a new major or minor version of an environment template. A major version of an environment template is a version that *isnât* backwards compatible. A minor version of an environment template is a version thatâs backwards compatible within its major version.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/CreateEnvironmentTemplateVersion)
...
The environment template detail data thatâs returned by Proton.
