# list-service-instance-provisioned-resourcesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/list-service-instance-provisioned-resources.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/proton/list-service-instance-provisioned-resources.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/ListServiceInstanceProvisionedResources)

`list-service-instance-provisioned-resources` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
