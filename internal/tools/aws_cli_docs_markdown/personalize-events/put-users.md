...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize-events/put-users.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize-events/put-users.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/personalize-events-2018-03-22/PutUsers)
...
The keys use camel case names that match the fields in the schema for the Users dataset. In the previous example, the `numberOfVideosWatched` matches the âNUMBER_OF_VIDEOS_WATCHEDâ field defined in the Users schema. For categorical string data, to include multiple categories for a single user, separate each category with a pipe separator (`|` ). For example, `\"Member|Frequent shopper\"` .
