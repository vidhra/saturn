...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/tag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/tag-resource.html)*
...
For more information, see [TagResource](https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_TagResource.html) in the *AWS IoT Analytics API Reference*.
