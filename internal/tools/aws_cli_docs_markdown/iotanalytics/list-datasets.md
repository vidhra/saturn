...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/list-datasets.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/list-datasets.html)*
...
For more information, see [ListDatasets](https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_ListDatasets.html) in the *AWS IoT Analytics API Reference*.
...
Information about the action that automatically creates the datasetâs contents.

actionName -> (string)

The name of the action that automatically creates the datasetâs contents.

actionType -> (string)

The type of action by which the datasetâs contents are automatically created.
