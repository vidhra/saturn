# get-dataset-contentÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/get-dataset-content.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/get-dataset-content.html)*
...
The version of the dataset whose contents are retrieved. You can also use the strings â$LATESTâ or â$LATEST_SUCCEEDEDâ to retrieve the contents of the latest or latest successfully completed dataset. If not specified, â$LATEST_SUCCEEDEDâ is the default.
...
For more information, see [GetDatasetContent](https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_GetDatasetContent.html) in the *guide*.
