...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/update-channel.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/update-channel.html)*
...
How long, in days, message data is kept for the channel. The retention period canât be updated if the channelâs Amazon S3 storage is customer-managed.
...
For more information, see [UpdateChannel](https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_UpdateChannel.html) in the *AWS IoT Analytics API Reference*.
