...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/delete-channel.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/delete-channel.html)*
...
For more information, see [DeleteChannel](https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_DeleteChannel.html) in the *AWS IoT Analytics API Reference*.
