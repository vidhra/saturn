# get-collaboration-id-namespace-associationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cleanrooms/get-collaboration-id-namespace-association.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cleanrooms/get-collaboration-id-namespace-association.html)*
...
The input reference configuration thatâs necessary to create the collaboration ID namespace association.
