# disassociate-delegate-from-resourceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/disassociate-delegate-from-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/disassociate-delegate-from-resource.html)*
...
Removes a member from the resourceâs set of delegates.
...
The identifier of the resource from which delegatesâ set members are removed.
...
The identifier for the member (user, group) to be removed from the resourceâs delegates.
