...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/update-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/update-resource.html)*
...
The resourceâs booking options to be updated.

AutoAcceptRequests -> (boolean)

The resourceâs ability to automatically reply to requests. If disabled, delegates must be associated to the resource.

AutoDeclineRecurringRequests -> (boolean)

The resourceâs ability to automatically decline any recurring requests.

AutoDeclineConflictingRequests -> (boolean)

The resourceâs ability to automatically decline any conflicting requests.
