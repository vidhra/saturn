...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/tag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/tag-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/workmail-2017-10-01/TagResource)
...
The following `tag-resource` example applies a tag with key âpriorityâ and value â1â to the specified Amazon WorkMail organization.
