# associate-member-to-groupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/associate-member-to-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/associate-member-to-group.html)*
...
Adds a member (user or group) to the groupâs set.
...
- Email address: [member@domain.tld](mailto:member%40domain.tld)
- Member name: member
