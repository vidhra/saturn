...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-resources.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-resources.html)*
...
Returns summaries of the organizationâs resources.
...
One page of the organizationâs resource representation.
...
The token used to paginate through all the organizationâs resources. While results are still available, it has an associated value. When the last page is reached, the token is empty.