...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-organizations.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-organizations.html)*
...
Returns summaries of the customerâs organizations.
...
The following `list-organizations` command retrieves summaries of the customerâs organizations.
