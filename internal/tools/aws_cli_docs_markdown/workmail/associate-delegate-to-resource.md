# associate-delegate-to-resourceÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/associate-delegate-to-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/associate-delegate-to-resource.html)*
...
Adds a member (user or group) to the resourceâs set of delegates.
