# list-mailbox-permissionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-mailbox-permissions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-mailbox-permissions.html)*
...
`list-mailbox-permissions` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
...
The following `list-mailbox-permissions` command retrieves the mailbox permissions associated with the specified entityâs mailbox.
...
The token to use to retrieve the next page of results. The value is ânullâ when there are no more results to return.