...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicediscovery/delete-service.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicediscovery/delete-service.html)*
...
For more information, see [Deleting services](https://docs.aws.amazon.com/cloud-map/latest/dg/deleting-services.html) in the *AWS Cloud Map Developer Guide*.
