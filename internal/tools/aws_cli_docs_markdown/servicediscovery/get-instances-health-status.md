# get-instances-health-statusÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicediscovery/get-instances-health-status.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicediscovery/get-instances-health-status.html)*
...
Thereâs a brief delay between when you register an instance and when the health status for the instance is available.
...
To get the IDs for the instances that youâve registered by using a specified service, submit a [ListInstances](https://docs.aws.amazon.com/cloud-map/latest/api/API_ListInstances.html) request.
...
The maximum number of instances that you want Cloud Map to return in the response to a `GetInstancesHealthStatus` request. If you donât specify a value for `MaxResults` , Cloud Map returns up to 100 instances.
