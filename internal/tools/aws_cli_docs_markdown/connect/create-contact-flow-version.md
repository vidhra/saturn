# create-contact-flow-versionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/create-contact-flow-version.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/create-contact-flow-version.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/CreateContactFlowVersion)
...
`--flow-content-sha256` (string)

Indicates the checksum value of the flow content.

`--contact-flow-version` (long)
