# create-push-notification-registrationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/create-push-notification-registration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/create-push-notification-registration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/CreatePushNotificationRegistration)
...
`--contact-configuration` (structure)
...
```
ContactId=string,ParticipantRole=string,IncludeRawMessage=boolean
```
