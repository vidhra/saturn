# batch-associate-analytics-data-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/batch-associate-analytics-data-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/batch-associate-analytics-data-set.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/BatchAssociateAnalyticsDataSet)
...
A list of errors for datasets that arenât successfully associated with the target account.
