# describe-phone-numberÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/describe-phone-number.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/describe-phone-number.html)*
...
Gets details and status of a phone number thatâs claimed to your Amazon Connect instance or traffic distribution group.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/DescribePhoneNumber)
...
Information about a phone number thatâs been claimed to your Amazon Connect instance or traffic distribution group.
