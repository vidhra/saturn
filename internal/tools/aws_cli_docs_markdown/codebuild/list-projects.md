...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codebuild/list-projects.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codebuild/list-projects.html)*
...
- `NAME` : List based on each build projectâs name.
...
Run this command again and provide the `nextToken` value from the previous response as a parameter to get the next part of the output. Repeat until you donât receive a `nextToken` value in the response.
