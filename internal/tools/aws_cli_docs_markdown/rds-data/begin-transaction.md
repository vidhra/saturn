...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds-data/begin-transaction.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds-data/begin-transaction.html)*
...
A transaction times out if no calls use its transaction ID in three minutes. If a transaction times out before itâs committed, itâs rolled back automatically.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/rds-data-2018-08-01/BeginTransaction)
