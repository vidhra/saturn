# reset-user-passwordÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/reset-user-password.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/reset-user-password.html)*
