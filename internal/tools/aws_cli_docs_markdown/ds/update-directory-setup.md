# update-directory-setupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/update-directory-setup.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/update-directory-setup.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ds-2015-04-16/UpdateDirectorySetup)
