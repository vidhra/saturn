...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/update-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/update-settings.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ds-2015-04-16/UpdateSettings)
