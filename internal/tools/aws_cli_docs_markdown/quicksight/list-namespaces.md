...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-namespaces.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-namespaces.html)*
...
Lists the namespaces for the specified Amazon Web Services account. This operation doesnât list deleted namespaces.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ListNamespaces)
