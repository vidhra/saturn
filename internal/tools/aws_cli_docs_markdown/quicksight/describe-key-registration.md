# describe-key-registrationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/describe-key-registration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/describe-key-registration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DescribeKeyRegistration)
...
`--default-key-only` | `--no-default-key-only` (boolean)
