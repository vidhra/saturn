# get-dashboard-for-job-runÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr-serverless/get-dashboard-for-job-run.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr-serverless/get-dashboard-for-job-run.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/emr-serverless-2021-07-13/GetDashboardForJobRun)
...
--job-run-id <value>
[--attempt <value>]
[--access-system-profile-logs | --no-access-system-profile-logs]
...
`--access-system-profile-logs` | `--no-access-system-profile-logs` (boolean)
...
The URL to view job runâs dashboard.