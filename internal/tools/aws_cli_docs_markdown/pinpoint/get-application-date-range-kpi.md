# get-application-date-range-kpiÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-application-date-range-kpi.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-application-date-range-kpi.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/GetApplicationDateRangeKpi)
...
ApplicationDateRangeKpiResponse -> (structure)
