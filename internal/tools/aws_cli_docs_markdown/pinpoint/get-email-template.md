...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-email-template.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-email-template.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/GetEmailTemplate)
...
The message body, in HTML format, thatâs used in email messages that are based on the message template.
...
The subject line, or title, thatâs used in email messages that are based on the message template.
...
The message body, in plain text format, thatâs used in email messages that are based on the message template.
