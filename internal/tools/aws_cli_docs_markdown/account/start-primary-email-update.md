# start-primary-email-updateÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/account/start-primary-email-update.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/account/start-primary-email-update.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/StartPrimaryEmailUpdate)
