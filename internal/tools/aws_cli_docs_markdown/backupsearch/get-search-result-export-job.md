# get-search-result-export-jobÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backupsearch/get-search-result-export-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backupsearch/get-search-result-export-job.html)*
...
An export job allows you to retain results of a search beyond the search jobâs scheduled retention of 7 days.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/backupsearch-2018-05-10/GetSearchResultExportJob)

## Synopsis

```
get-search-result-export-job
--export-job-identifier <value>
...
ExportSpecification -> (tagged union structure)
