...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lookoutvision/start-model.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lookoutvision/start-model.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/lookoutvision-2020-11-20/StartModel)
...
If you donât supply a value for `ClientToken` , the AWS SDK you are using inserts a value for you. This prevents retries after a network error from making multiple start requests. Youâll need to provide your own value for other use cases.
...
The maximum number of inference units to use for auto-scaling the model. If you donât specify a value, Amazon Lookout for Vision doesnât auto-scale the model.
