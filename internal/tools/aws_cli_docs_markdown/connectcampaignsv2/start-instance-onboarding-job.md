# start-instance-onboarding-jobÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connectcampaignsv2/start-instance-onboarding-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connectcampaignsv2/start-instance-onboarding-job.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/StartInstanceOnboardingJob)
