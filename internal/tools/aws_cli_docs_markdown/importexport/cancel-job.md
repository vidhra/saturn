...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/importexport/cancel-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/importexport/cancel-job.html)*
...
Only jobs that were created by the AWS account youâre currently using can be canceled. Jobs that have already completed cannot be canceled.
