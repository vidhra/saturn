...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/update-application-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/update-application-settings.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ssm-sap-2018-05-10/UpdateApplicationSettings)
...
[--credentials-to-add-or-update <value>]
[--credentials-to-remove <value>]
[--backint <value>]
[--database-arn <value>]
...
`--credentials-to-add-or-update` (list)
...
```
BackintMode=string,EnsureNoBackupInProcess=boolean
```
