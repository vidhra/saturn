...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/stop-application.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-sap/stop-application.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ssm-sap-2018-05-10/StopApplication)
...
[--stop-connected-entity <value>]
[--include-ec2-instance-shutdown | --no-include-ec2-instance-shutdown]
...
`--include-ec2-instance-shutdown` | `--no-include-ec2-instance-shutdown` (boolean)
