...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/keyspaces/list-tables.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/keyspaces/list-tables.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/keyspaces-2022-02-10/ListTables)
