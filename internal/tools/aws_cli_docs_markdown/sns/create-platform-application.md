# create-platform-applicationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sns/create-platform-application.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sns/create-platform-application.html)*
...
For a list of attributes, see ` `SetPlatformApplicationAttributes` [https://docs.aws.amazon.com/sns/latest/api/API_SetPlatformApplicationAttributes](https://docs.aws.amazon.com/sns/latest/api/API_SetPlatformApplicationAttributes).html`__ .
