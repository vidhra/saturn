# check-if-phone-number-is-opted-outÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sns/check-if-phone-number-is-opted-out.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sns/check-if-phone-number-is-opted-out.html)*
...
- `true` â The phone number is opted out, meaning you cannot publish SMS messages to it.
- `false` â The phone number is opted in, meaning you can publish SMS messages to it.