# create-platform-endpointÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sns/create-platform-endpoint.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sns/create-platform-endpoint.html)*
...
For a list of attributes, see ` `SetEndpointAttributes` [https://docs.aws.amazon.com/sns/latest/api/API_SetEndpointAttributes](https://docs.aws.amazon.com/sns/latest/api/API_SetEndpointAttributes).html`__ .
