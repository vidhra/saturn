...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/list-rules.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/list-rules.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/eventbridge-2015-10-07/ListRules)
...
This example displays all CloudWatch Events rules in the region that have a name starting with âDailyâ:
...
The scheduling expression. For example, âcron(0 20 * * ? [*](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/list-rules.html#id1))â, ârate(5 minutes)â. For more information, see [Creating an Amazon EventBridge rule that runs on a schedule](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-create-rule-schedule.html) .
