...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/test-event-pattern.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/test-event-pattern.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/eventbridge-2015-10-07/TestEventPattern)
...
This example tests whether the pattern âsource:com.mycompany.myappâ matches the specified event. In this example, the output would be âtrueâ:
