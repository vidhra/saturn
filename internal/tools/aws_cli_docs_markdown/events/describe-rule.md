...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/describe-rule.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/describe-rule.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/eventbridge-2015-10-07/DescribeRule)
...
The scheduling expression. For example, âcron(0 20 * * ? [*](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/describe-rule.html#id1))â, ârate(5 minutes)â.
