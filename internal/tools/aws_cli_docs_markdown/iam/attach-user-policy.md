...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/attach-user-policy.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/attach-user-policy.html)*
...
You use this operation to attach a *managed* policy to a user. To embed an inline policy in a user, use ` `PutUserPolicy` [https://docs.aws.amazon.com/IAM/latest/APIReference/API_PutUserPolicy](https://docs.aws.amazon.com/IAM/latest/APIReference/API_PutUserPolicy).html`__ .
