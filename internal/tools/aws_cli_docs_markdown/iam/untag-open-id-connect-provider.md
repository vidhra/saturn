# untag-open-id-connect-providerÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-open-id-connect-provider.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-open-id-connect-provider.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagOpenIDConnectProvider)
...
The following `untag-open-id-connect-provider` command removes any tag with the key name âDepartmentâ from the specified OIDC identity provider.
