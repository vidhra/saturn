...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-role.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-role.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagRole)
...
The following `untag-role` command removes any tag with the key name âDepartmentâ from the specified role.
