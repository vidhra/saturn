...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/set-default-policy-version.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/set-default-policy-version.html)*
...
Sets the specified version of the specified policy as the policyâs default (operative) version.
...
**To set the specified version of the specified policy as the policyâs default version.**
