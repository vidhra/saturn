...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-user.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-user.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagUser)
...
The following `untag-user` command removes any tag with the key name âDepartmentâ from the specified user.
