# untag-saml-providerÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-saml-provider.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-saml-provider.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagSAMLProvider)
...
The following `untag-saml-provider` command removes any tag with the key name âDepartmentâ from the specified instance profile.
