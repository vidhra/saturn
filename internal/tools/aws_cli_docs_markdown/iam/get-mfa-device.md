...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/get-mfa-device.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/get-mfa-device.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/GetMFADevice)
...
The date that a specified userâs MFA device was first enabled.

Certifications -> (map)

The certifications of a specified userâs MFA device. We currently provide FIPS-140-2, FIPS-140-3, and FIDO certification levels obtained from [FIDO Alliance Metadata Service (MDS)](https://fidoalliance.org/metadata/) .
