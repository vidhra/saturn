# untag-server-certificateÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-server-certificate.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-server-certificate.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagServerCertificate)
...
The following `untag-server-certificate` command removes any tag with the key name âDepartmentâ from the specified server certificate.
