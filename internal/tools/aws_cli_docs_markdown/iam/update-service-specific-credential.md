# update-service-specific-credentialÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/update-service-specific-credential.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/update-service-specific-credential.html)*
...
**Example 1: To update the status of the requesting userâs service-specific credential**
...
**Example 2: To update the status of a specified userâs service-specific credential**
