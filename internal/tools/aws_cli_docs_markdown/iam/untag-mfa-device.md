...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-mfa-device.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-mfa-device.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagMFADevice)
...
The following `untag-mfa-device` command removes any tag with the key name âDepartmentâ from the specified MFA device.
