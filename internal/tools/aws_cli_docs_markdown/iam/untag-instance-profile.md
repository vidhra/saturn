# untag-instance-profileÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-instance-profile.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-instance-profile.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagInstanceProfile)
...
The following `untag-instance-profile` command removes any tag with the key name âDepartmentâ from the specified instance profile.
