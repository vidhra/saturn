...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-policy.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/untag-policy.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/UntagPolicy)
...
The following `untag-policy` command removes any tag with the key name âDepartmentâ from the specified customer managed policy.
