...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmonitor/update-monitor.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmonitor/update-monitor.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/networkmonitor-2023-08-01/UpdateMonitor)
...
The following `update-monitor` example changes a monitorâs `aggregationPeriod` from `60` seconds to `30` seconds.
