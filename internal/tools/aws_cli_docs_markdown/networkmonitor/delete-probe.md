...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmonitor/delete-probe.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmonitor/delete-probe.html)*
...
Deletes the specified probe. Once a probe is deleted youâll no longer incur any billing fees for that probe.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/networkmonitor-2023-08-01/DeleteProbe)
