...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmonitor/get-probe.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmonitor/get-probe.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/networkmonitor-2023-08-01/GetProbe)
...
The following `get-probe` example returns details about a probe with the `probeID` `probe-12345` thatâs associated with a monitor named `Example_NetworkMonitor`.
