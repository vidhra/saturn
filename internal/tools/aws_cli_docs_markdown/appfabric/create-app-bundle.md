...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appfabric/create-app-bundle.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appfabric/create-app-bundle.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/CreateAppBundle)
...
create-app-bundle
[--client-token <value>]
[--customer-managed-key-identifier <value>]
[--tags <value>]
...
`--customer-managed-key-identifier` (string)
