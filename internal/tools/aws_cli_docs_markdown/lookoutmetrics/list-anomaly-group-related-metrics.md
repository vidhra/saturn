# list-anomaly-group-related-metricsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lookoutmetrics/list-anomaly-group-related-metrics.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lookoutmetrics/list-anomaly-group-related-metrics.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/lookoutmetrics-2017-07-25/ListAnomalyGroupRelatedMetrics)
