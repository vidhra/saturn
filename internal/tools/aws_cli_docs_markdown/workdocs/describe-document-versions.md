# describe-document-versionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/describe-document-versions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/describe-document-versions.html)*
...
A comma-separated list of values. Specify âINITIALIZEDâ to include incomplete versions.

`--fields` (string)

Specify âSOURCEâ to include initialized versions and a URL for the source document.
...
**To retrieve a documentâs versions**
