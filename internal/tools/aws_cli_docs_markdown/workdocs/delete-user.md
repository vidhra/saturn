...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/delete-user.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/delete-user.html)*
...
Deleting a user immediately and permanently deletes all content in that userâs folder structure. Site retention policies do NOT apply to this type of deletion.
