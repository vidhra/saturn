...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/directconnect/update-connection.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/directconnect/update-connection.html)*
...
- The connection name
- The connectionâs MAC Security (MACsec) encryption mode.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/directconnect-2012-10-25/UpdateConnection)
