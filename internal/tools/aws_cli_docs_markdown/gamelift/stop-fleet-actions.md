...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/stop-fleet-actions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/stop-fleet-actions.html)*
...
- To stop actions on instances in the fleetâs home Region, provide a fleet ID and the type of actions to suspend.
- To stop actions on instances in one of the fleetâs remote locations, provide a fleet ID, a location name, and the type of actions to suspend.
...
**To stop a fleetâs automatic scaling activity**
