# create-workspace-imageÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/create-workspace-image.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/create-workspace-image.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/workspaces-2015-04-08/CreateWorkspaceImage)
...
The tags that you want to add to the new WorkSpace image. To add tags when youâre creating the image, you must create an IAM policy that grants your IAM user permission to use `workspaces:CreateTags` .
