# modify-endpoint-encryption-modeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/modify-endpoint-encryption-mode.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/modify-endpoint-encryption-mode.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/workspaces-2015-04-08/ModifyEndpointEncryptionMode)
...
modify-endpoint-encryption-mode
--directory-id <value>
--endpoint-encryption-mode <value>
...
`--endpoint-encryption-mode` (string)
