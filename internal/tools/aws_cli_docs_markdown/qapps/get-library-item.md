...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qapps/get-library-item.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qapps/get-library-item.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/qapps-2023-11-27/GetLibraryItem)
...
The status of the library item, such as âPublishedâ.
