# batch-create-categoryÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qapps/batch-create-category.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qapps/batch-create-category.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/qapps-2023-11-27/BatchCreateCategory)
...
The unique identifier to be associated with a category. If you donât include a value, the category is automatically assigned a unique identifier.
