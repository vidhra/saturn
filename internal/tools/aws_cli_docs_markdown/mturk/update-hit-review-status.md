# update-hit-review-statusÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/update-hit-review-status.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/update-hit-review-status.html)*
