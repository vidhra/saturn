...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/delete-hit.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/delete-hit.html)*
...
- After you dispose of a HIT, you can no longer approve the HITâs rejected assignments.
