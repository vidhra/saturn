# reject-qualification-requestÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/reject-qualification-request.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/reject-qualification-request.html)*
...
The `RejectQualificationRequest` operation rejects a userâs request for a Qualification.
