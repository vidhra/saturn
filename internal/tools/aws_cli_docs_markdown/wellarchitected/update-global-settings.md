...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/update-global-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/update-global-settings.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/wellarchitected-2020-03-31/UpdateGlobalSettings)
...
`--organization-sharing-status` (string)
...
`--discovery-integration-status` (string)
...
```
IssueManagementStatus=string,IssueManagementType=string,JiraProjectKey=string,IntegrationStatus=string
```
