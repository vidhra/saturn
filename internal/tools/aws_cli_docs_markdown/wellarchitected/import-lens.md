...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/import-lens.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/import-lens.html)*
...
The new or updated lens will have a status of `DRAFT` . The lens cannot be applied to workloads or shared with other Amazon Web Services accounts until itâs published with  CreateLensVersion .
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/wellarchitected-2020-03-31/ImportLens)
