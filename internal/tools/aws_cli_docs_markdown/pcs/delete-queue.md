...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pcs/delete-queue.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pcs/delete-queue.html)*
...
Deletes a job queue. If the compute node group associated with this queue isnât associated with any other queues, Amazon Web Services PCS terminates all the compute nodes for this queue.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/DeleteQueue)
