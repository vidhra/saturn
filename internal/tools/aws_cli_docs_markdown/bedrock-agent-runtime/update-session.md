...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/update-session.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/update-session.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/UpdateSession)
...
The unique identifier of the session to modify. You can specify either the sessionâs `sessionId` or its Amazon Resource Name (ARN).

`--session-metadata` (map)

A map of key-value pairs containing attributes to be persisted across the session. For example the userâs ID, their language preference, and the type of device they are using.
