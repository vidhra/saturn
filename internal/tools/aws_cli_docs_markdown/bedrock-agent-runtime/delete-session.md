...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/delete-session.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/delete-session.html)*
...
The unique identifier for the session to be deleted. You can specify either the sessionâs `sessionId` or its Amazon Resource Name (ARN).
