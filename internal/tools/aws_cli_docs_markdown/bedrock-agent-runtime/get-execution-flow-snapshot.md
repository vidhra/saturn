# get-execution-flow-snapshotÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/get-execution-flow-snapshot.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/get-execution-flow-snapshot.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/GetExecutionFlowSnapshot)
...
The Amazon Resource Name (ARN) of the customer managed KMS key thatâs used to encrypt the flow snapshot.
...
The Amazon Resource Name (ARN) of the IAM service role thatâs used by the async execution.
