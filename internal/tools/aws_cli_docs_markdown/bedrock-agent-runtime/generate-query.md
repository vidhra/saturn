...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/generate-query.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent-runtime/generate-query.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/GenerateQuery)
...
`--query-generation-input` (structure)
...
textToSqlConfiguration -> (structure)
...
```
mode=string,textToSqlConfiguration={knowledgeBaseConfiguration={knowledgeBaseArn=string},type=string}
```
