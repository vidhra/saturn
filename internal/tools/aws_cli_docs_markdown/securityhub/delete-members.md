...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/delete-members.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/delete-members.html)*
...
You can invoke this API only to delete accounts that became members through invitation. You canât invoke this API to delete accounts that belong to an Organizations organization.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/DeleteMembers)
