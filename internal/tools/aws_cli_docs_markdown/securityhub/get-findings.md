...
Valid values: `RSA_2048` | `RSA_1024` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id1)`RSA_4096` | `EC_prime256v1` | `EC_secp384r1` | `EC_secp521r1`
...
Valid values: `available` | `available, prep-for-resize` | `available, resize-cleanup` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id3)`cancelling-resize` | `creating` | `deleting` | `final-snapshot` | `hardware-failure` | `incompatible-hsm` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id5)`incompatible-network` | `incompatible-parameters` | `incompatible-restore` | `modifying` | `paused` | `rebooting` | `renaming` | `resizing` | `rotating-keys` | `storage-full` | `updating-hsm`
...
For the TCP protocol, the target is specified as [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id7)TCP: *<port>* `` .

For the SSL protocol, the target is specified as [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id9)SSL.*<port>* `` .
...
For the day values, use `mon` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id11)`tue` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id13)`wed` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id15)`thu` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id17)`fri` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id19)`sat` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id21)`sun` .
...
For the day values, use `mon` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id25)`tue` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id27)`wed` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id29)`thu` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id31)`fri` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id33)`sat` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id35)`sun` .
...
Valid values: `"ALL"` | `"AUDIT_CONTROL"` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id37)`"AUDIT_WRITE"` | `"BLOCK_SUSPEND"` | `"CHOWN"` | `"DAC_OVERRIDE"` | `"DAC_READ_SEARCH"` | `"FOWNER"` | `"FSETID"` | `"IPC_LOCK"` | `"IPC_OWNER"` | `"KILL"` | `"LEASE"` | `"LINUX_IMMUTABLE"` | `"MAC_ADMIN"` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id39)`"MAC_OVERRIDE"` | `"MKNOD"` | `"NET_ADMIN"` | `"NET_BIND_SERVICE"` | `"NET_BROADCAST"` | `"NET_RAW"` | `"SETFCAP"` | `"SETGID"` | `"SETPCAP"` | `"SETUID"` | `"SYS_ADMIN"` | `"SYS_BOOT"` | `"SYS_CHROOT"` | `"SYS_MODULE"` | `"SYS_NICE"` | `"SYS_PACCT"` | `"SYS_PTRACE"` | `"SYS_RAWIO"` | `"SYS_RESOURCE"` | `"SYS_TIME"` | `"SYS_TTY_CONFIG"` | `"SYSLOG"` | `"WAKE_ALARM"`
...
Valid values: `"ALL"` | `"AUDIT_CONTROL"` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id41)`"AUDIT_WRITE"` | `"BLOCK_SUSPEND"` | `"CHOWN"` | `"DAC_OVERRIDE"` | `"DAC_READ_SEARCH"` | `"FOWNER"` | `"FSETID"` | `"IPC_LOCK"` | `"IPC_OWNER"` | `"KILL"` | `"LEASE"` | `"LINUX_IMMUTABLE"` | `"MAC_ADMIN"` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id43)`"MAC_OVERRIDE"` | `"MKNOD"` | `"NET_ADMIN"` | `"NET_BIND_SERVICE"` | `"NET_BROADCAST"` | `"NET_RAW"` | `"SETFCAP"` | `"SETGID"` | `"SETPCAP"` | `"SETUID"` | `"SYS_ADMIN"` | `"SYS_BOOT"` | `"SYS_CHROOT"` | `"SYS_MODULE"` | `"SYS_NICE"` | `"SYS_PACCT"` | `"SYS_PTRACE"` | `"SYS_RAWIO"` | `"SYS_RESOURCE"` | `"SYS_TIME"` | `"SYS_TTY_CONFIG"` | `"SYSLOG"` | `"WAKE_ALARM"`
...
Valid values: `"defaults"` | `"ro"` | `"rw"` | `"suid"` | `"nosuid"` | `"dev"` | `"nodev"` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id45)`"exec"` | `"noexec"` | `"sync"` | `"async"` | `"dirsync"` | `"remount"` | `"mand"` | `"nomand"` | `"atime"` | `"noatime"` | `"diratime"` | `"nodiratime"` | `"bind"` | `"rbind"` | `"unbindable"` | `"runbindable"` | `"private"` | `"rprivate"` | `"shared"` | `"rshared"` | `"slave"` | `"rslave"` | `"relatime"` | `"norelatime"` | `"strictatime"` | `"nostrictatime"` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id47)`"mode"` | `"uid"` | `"gid"` | `"nr_inodes"` [|](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id49)`"nr_blocks"` | `"mpol"`
...
- [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id51)*user* ``
- `*user* `` :` *group* ``
- [``](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-findings.html#id53)*uid* ``
- `*uid* `` :` *gid* ``
- `*user* `` :` *gid* ``
- `*uid* `` :` *group* ``
