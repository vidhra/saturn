...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/invite-members.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/invite-members.html)*
...
This operation is only used to invite accounts that donât belong to an Amazon Web Services organization. Organization accounts donât receive invitations.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/InviteMembers)
