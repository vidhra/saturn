...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/b2bi/test-parsing.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/b2bi/test-parsing.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/b2bi-2022-06-23/TestParsing)
