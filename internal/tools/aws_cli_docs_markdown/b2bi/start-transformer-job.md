# start-transformer-jobÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/b2bi/start-transformer-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/b2bi/start-transformer-job.html)*
...
If you only want to transform EDI (electronic data interchange) documents, you donât need to create profiles, partnerships or capabilities. Just create and configure a transformer, and then run the `StartTransformerJob` API to process your files.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/b2bi-2022-06-23/StartTransformerJob)
