...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-ip-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-ip-set.html)*
...
Permanently deletes an  IPSet . You canât delete an `IPSet` if itâs still used in any `Rules` or if it still includes any IP addresses.
