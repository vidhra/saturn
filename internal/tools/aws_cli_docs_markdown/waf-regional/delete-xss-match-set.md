# delete-xss-match-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-xss-match-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-xss-match-set.html)*
...
Permanently deletes an  XssMatchSet . You canât delete an `XssMatchSet` if itâs still used in any `Rules` or if it still contains any  XssMatchTuple objects.
