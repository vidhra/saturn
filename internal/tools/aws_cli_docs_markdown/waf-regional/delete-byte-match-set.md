# delete-byte-match-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-byte-match-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-byte-match-set.html)*
...
Permanently deletes a  ByteMatchSet . You canât delete a `ByteMatchSet` if itâs still used in any `Rules` or if it still includes any  ByteMatchTuple objects (any filters).
