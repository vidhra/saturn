# delete-regex-pattern-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-regex-pattern-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-regex-pattern-set.html)*
...
Permanently deletes a  RegexPatternSet . You canât delete a `RegexPatternSet` if itâs still used in any `RegexMatchSet` or if the `RegexPatternSet` is not empty.
