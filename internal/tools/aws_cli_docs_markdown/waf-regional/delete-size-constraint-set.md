# delete-size-constraint-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-size-constraint-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-size-constraint-set.html)*
...
Permanently deletes a  SizeConstraintSet . You canât delete a `SizeConstraintSet` if itâs still used in any `Rules` or if it still includes any  SizeConstraint objects (any filters).
