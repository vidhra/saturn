...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-rule-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-rule-group.html)*
...
Permanently deletes a  RuleGroup . You canât delete a `RuleGroup` if itâs still used in any `WebACL` objects or if it still includes any rules.
