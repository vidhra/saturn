# delete-sql-injection-match-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-sql-injection-match-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-sql-injection-match-set.html)*
...
Permanently deletes a  SqlInjectionMatchSet . You canât delete a `SqlInjectionMatchSet` if itâs still used in any `Rules` or if it still contains any  SqlInjectionMatchTuple objects.
