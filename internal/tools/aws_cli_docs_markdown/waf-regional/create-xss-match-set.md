# create-xss-match-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/create-xss-match-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/create-xss-match-set.html)*
...
A friendly name or description for the  XssMatchSet that youâre creating. You canât change `Name` after you create the `XssMatchSet` .
