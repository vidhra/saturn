...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-web-acl.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-web-acl.html)*
...
Permanently deletes a  WebACL . You canât delete a `WebACL` if it still contains any `Rules` .
