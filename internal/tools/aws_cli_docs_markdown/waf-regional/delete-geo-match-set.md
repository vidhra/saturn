# delete-geo-match-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-geo-match-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-geo-match-set.html)*
...
Permanently deletes a  GeoMatchSet . You canât delete a `GeoMatchSet` if itâs still used in any `Rules` or if it still includes any countries.
