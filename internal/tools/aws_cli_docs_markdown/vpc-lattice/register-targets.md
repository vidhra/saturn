...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/register-targets.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/register-targets.html)*
...
Registers the targets with the target group. If itâs a Lambda target, you can only have one target in a target group.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice-2022-11-30/RegisterTargets)
...
The port on which the target is listening. This parameter doesnât apply if the target is a Lambda function.