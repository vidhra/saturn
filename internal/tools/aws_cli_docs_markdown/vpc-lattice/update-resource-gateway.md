# update-resource-gatewayÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/update-resource-gateway.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/update-resource-gateway.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice-2022-11-30/UpdateResourceGateway)
