...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configure/sso-session.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configure/sso-session.html)*
...
The `aws configure sso-session` command interactively prompts for the configuration values required to create a SSO session. The SSO session can then be associated to a profile to retrieve SSO access tokens and AWS credentials.
