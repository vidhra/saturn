...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/modify-global-cluster.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/modify-global-cluster.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ModifyGlobalCluster)
...
The identifier for the global cluster being modified. This parameter isnât case-sensitive.
...
- Must contain from 1 to 63 letters, numbers, or hyphens The first character must be a letter Canât end with a hyphen or contain two consecutive hyphens

Example: `my-cluster2`

`--deletion-protection` | `--no-deletion-protection` (boolean)

Indicates if the global cluster has deletion protection enabled. The global cluster canât be deleted when deletion protection is enabled.
