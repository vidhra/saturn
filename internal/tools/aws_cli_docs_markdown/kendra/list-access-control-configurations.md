# list-access-control-configurationsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/list-access-control-configurations.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/list-access-control-configurations.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/ListAccessControlConfigurations)
...
If the previous response was incomplete (because thereâs more data to retrieve), Amazon Kendra returns a pagination token in the response. You can use this pagination token to retrieve the next set of access control configurations.
