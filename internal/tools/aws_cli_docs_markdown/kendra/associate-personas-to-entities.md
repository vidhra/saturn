# associate-personas-to-entitiesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/associate-personas-to-entities.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/associate-personas-to-entities.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/AssociatePersonasToEntities)
...
```
EntityId=string,Persona=string ...
```
