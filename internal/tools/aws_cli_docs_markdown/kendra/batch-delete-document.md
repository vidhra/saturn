...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/batch-delete-document.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/batch-delete-document.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/BatchDeleteDocument)
...
A list of documents that could not be removed from the index. Each entry contains an error message that indicates why the document couldnât be removed from the index.
...
The identifier of the document that couldnât be removed from the index.
...
The error code for why the document couldnât be removed from the index.
