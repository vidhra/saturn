...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/untag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/untag-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/UntagResource)
...
A list of tag keys to remove from the index, FAQ, data source, or other resource. If a tag key doesnât exist for the resource, it is ignored.
