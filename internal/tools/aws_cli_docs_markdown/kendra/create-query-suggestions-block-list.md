# create-query-suggestions-block-listÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/create-query-suggestions-block-list.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/create-query-suggestions-block-list.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/CreateQuerySuggestionsBlockList)
...
For example, the name âoffensive-wordsâ, which includes all offensive words that could appear in user queries and need to be blocked from suggestions.

`--description` (string)

A description for the block list.

For example, the description âList of all offensive words that can appear in user queries and need to be blocked from suggestions.â
