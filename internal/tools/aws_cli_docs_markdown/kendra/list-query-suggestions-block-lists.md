# list-query-suggestions-block-listsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/list-query-suggestions-block-lists.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/list-query-suggestions-block-lists.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/ListQuerySuggestionsBlockLists)
