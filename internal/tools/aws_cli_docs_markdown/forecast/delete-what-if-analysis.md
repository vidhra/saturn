# delete-what-if-analysisÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/delete-what-if-analysis.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/delete-what-if-analysis.html)*
...
You canât delete a what-if analysis while any of its forecasts are being exported.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/forecast-2018-06-26/DeleteWhatIfAnalysis)
