# create-what-if-forecast-exportÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/create-what-if-forecast-export.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/create-what-if-forecast-export.html)*
...
`â<ForecastExportJobName>_<ExportTimestamp>_<PartNumber>`
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/forecast-2018-06-26/CreateWhatIfForecastExport)
...
`--what-if-forecast-export-name` (string)

The name of the what-if forecast to export.

`--what-if-forecast-arns` (list)
