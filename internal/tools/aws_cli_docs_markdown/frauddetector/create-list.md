...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/create-list.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/create-list.html)*
...
List is a set of input data for a variable in your event dataset. You use the input data in a rule thatâs associated with your detector. For more information, see [Lists](https://docs.aws.amazon.com/frauddetector/latest/ug/lists.html) .

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/frauddetector-2019-11-15/CreateList)
