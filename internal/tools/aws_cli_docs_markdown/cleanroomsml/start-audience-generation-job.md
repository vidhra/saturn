# start-audience-generation-jobÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cleanroomsml/start-audience-generation-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cleanroomsml/start-audience-generation-job.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/cleanroomsml-2023-09-06/StartAudienceGenerationJob)
...
```
dataSource={s3Uri=string},roleArn=string,sqlParameters={queryString=string,analysisTemplateArn=string,parameters={KeyName1=string,KeyName2=string}},sqlComputeConfiguration={worker={type=string,number=integer}}
```
...
`--include-seed-in-output` | `--no-include-seed-in-output` (boolean)
