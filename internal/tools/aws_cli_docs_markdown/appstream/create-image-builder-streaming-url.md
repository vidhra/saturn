# create-image-builder-streaming-urlÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/create-image-builder-streaming-url.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/create-image-builder-streaming-url.html)*
