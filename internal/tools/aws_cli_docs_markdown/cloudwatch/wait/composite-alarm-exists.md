# composite-alarm-existsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/wait/composite-alarm-exists.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/wait/composite-alarm-exists.html)*

[ [aws](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/index.html#cli-aws) . [cloudwatch](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/index.html#cli-aws-cloudwatch) . [wait](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/wait/index.html#cli-aws-cloudwatch-wait) ]
...
`composite-alarm-exists` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
