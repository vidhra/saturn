# disable-alarm-actionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/disable-alarm-actions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/disable-alarm-actions.html)*
...
Disables the actions for the specified alarms. When an alarmâs actions are disabled, the alarm actions do not execute when the alarm state changes.
