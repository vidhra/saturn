...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/start-session.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/start-session.html)*
...
Amazon Web Services Tools for PowerShell usage: Start-SSMSession isnât currently supported by Amazon Web Services Tools for PowerShell on Windows local machines.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ssm-2014-11-06/StartSession)
