...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/delete-parameters.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/delete-parameters.html)*
...
The names of parameters that werenât deleted because the parameters arenât valid.
