# create-job-templateÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/create-job-template.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/create-job-template.html)*
...
Create a new job template. For information about job templates see the User Guide at [http://docs.aws.amazon.com/mediaconvert/latest/ug/what-is.html](http://docs.aws.amazon.com/mediaconvert/latest/ug/what-is.html)
