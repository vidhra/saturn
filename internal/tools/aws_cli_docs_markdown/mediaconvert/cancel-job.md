...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/cancel-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/cancel-job.html)*
...
Permanently cancel a job. Once you have canceled a job, you canât start it again.
...
The following `cancel-job` example cancels the job with ID `1234567891234-abc123`. You canât cancel a job that the service has started processing.
