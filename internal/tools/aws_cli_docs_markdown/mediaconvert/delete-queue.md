...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/delete-queue.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/delete-queue.html)*
...
You canât delete your default queue. You canât delete a reserved queue that has an active pricing plan or that contains unprocessed jobs.
