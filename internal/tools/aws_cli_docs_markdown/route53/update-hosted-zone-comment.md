# update-hosted-zone-commentÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53/update-hosted-zone-comment.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53/update-hosted-zone-comment.html)*
...
The new comment for the hosted zone. If you donât specify a value for `Comment` , Amazon Route 53 deletes the existing value of the `Comment` element, if any.
