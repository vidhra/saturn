...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/update-alias.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/update-alias.html)*
...
Identifies the [customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk) to associate with the alias. You donât have permission to associate an alias with an [Amazon Web Services managed key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-cmk) .
...
- The `--target-key-id` parameter specifies the KMS key to associate with the alias. You donât need to specify the current KMS key for the alias.
