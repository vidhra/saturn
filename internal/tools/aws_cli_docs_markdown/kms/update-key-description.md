# update-key-descriptionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/update-key-description.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/update-key-description.html)*
...
- The `--description` parameter with an empty string value (ââ) deletes the existing description.
