# get-device-positionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/location/get-device-position.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/location/get-device-position.html)*
...
Retrieves a deviceâs most recent position according to its sample time.

### Note

Device positions are deleted after 30 days.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/location-2020-11-19/GetDevicePosition)
