# list-data-set-revisionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dataexchange/list-data-set-revisions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dataexchange/list-data-set-revisions.html)*
...
This operation lists a data setâs revisions sorted by CreatedAt in descending order.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/dataexchange-2017-07-25/ListDataSetRevisions)

`list-data-set-revisions` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
