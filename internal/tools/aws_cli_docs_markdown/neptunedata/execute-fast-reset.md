...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptunedata/execute-fast-reset.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptunedata/execute-fast-reset.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/neptunedata-2023-08-01/ExecuteFastReset)
...
- [**](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptunedata/execute-fast-reset.html#id1)`initiateDatabaseReset` ** â This action generates a unique token needed to actually perform the fast reset.
- [**](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptunedata/execute-fast-reset.html#id3)`performDatabaseReset` ** â This action uses the token generated by the `initiateDatabaseReset` action to actually perform the fast reset.
