...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/get-tags.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/get-tags.html)*
...
When you use `SortBy` , `NextPageToken` and `SearchString` arenât supported.
...
This example retrieves all cost allocation tags with a key of âProjectâ and a value that contains âsecretProjectâ.
