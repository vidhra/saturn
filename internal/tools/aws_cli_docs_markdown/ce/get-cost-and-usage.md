...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/get-cost-and-usage.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/get-cost-and-usage.html)*
...
Sets the Amazon Web Services cost granularity to `MONTHLY` or `DAILY` , or `HOURLY` . If `Granularity` isnât set, the response object doesnât include the `Granularity` , either `MONTHLY` or `DAILY` , or `HOURLY` .
