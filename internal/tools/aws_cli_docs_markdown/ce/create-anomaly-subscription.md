# create-anomaly-subscriptionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/create-anomaly-subscription.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/create-anomaly-subscription.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/CreateAnomalySubscription)
...
An optional list of tags to associate with the specified ` `AnomalySubscription` [https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_AnomalySubscription](https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_AnomalySubscription).html`__ . You can use resource tags to control access to your `subscription` using IAM policies.
