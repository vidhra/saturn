# cache-cluster-deletedÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/wait/cache-cluster-deleted.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/wait/cache-cluster-deleted.html)*
