# create-queue-environmentÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/create-queue-environment.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/create-queue-environment.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/CreateQueueEnvironment)
...
The templateâs file type, `JSON` or `YAML` .
