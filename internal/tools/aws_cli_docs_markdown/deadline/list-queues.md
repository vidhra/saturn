...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-queues.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-queues.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListQueues)
...
- `ACTIVE` âThe queues are active.
- `SCHEDULING` âThe queues are scheduling.
- `SCHEDULING_BLOCKED` âThe queue scheduling is blocked for these queues.
...
The default action taken on a queue summary if a budget wasnât configured.
