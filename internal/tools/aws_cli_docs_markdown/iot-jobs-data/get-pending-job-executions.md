# get-pending-job-executionsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-jobs-data/get-pending-job-executions.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-jobs-data/get-pending-job-executions.html)*
...
The following `get-pending-job-executions` example displays a list of all jobs that arenât in a terminal state for the specified thing.
