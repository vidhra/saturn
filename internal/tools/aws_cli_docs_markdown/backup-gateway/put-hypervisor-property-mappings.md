# put-hypervisor-property-mappingsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup-gateway/put-hypervisor-property-mappings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup-gateway/put-hypervisor-property-mappings.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/backup-gateway-2021-01-01/PutHypervisorPropertyMappings)
...
The key part of the Amazon Web Services tagâs key-value pair.

AwsTagValue -> (string)

The value part of the Amazon Web Services tagâs key-value pair.
