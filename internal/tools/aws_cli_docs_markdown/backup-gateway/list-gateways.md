...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup-gateway/list-gateways.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup-gateway/list-gateways.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/backup-gateway-2021-01-01/ListGateways)
...
A gateway is an Backup Gateway appliance that runs on the customerâs network to provide seamless connectivity to backup storage in the Amazon Web Services Cloud.
