# submit-task-state-changeÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/submit-task-state-change.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/submit-task-state-change.html)*
...
Any containers thatâs associated with the state change request.
...
The details for the managed agent thatâs associated with the task.
...
The name of the container thatâs associated with the managed agent.
