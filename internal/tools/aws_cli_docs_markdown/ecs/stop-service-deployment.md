# stop-service-deploymentÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/stop-service-deployment.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/stop-service-deployment.html)*
...
- ROLLBACK - This option rolls back the service deployment to the previous service revision.  You can use this option even if you didnât configure the service deployment for the rollback option.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/StopServiceDeployment)

## Synopsis

```
stop-service-deployment
--service-deployment-arn <value>
[--stop-type <value>]
