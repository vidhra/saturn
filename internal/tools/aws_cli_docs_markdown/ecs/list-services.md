...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/list-services.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/list-services.html)*
...
The list of full ARN entries for each service thatâs associated with the specified cluster.
