...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/list-clusters.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/list-clusters.html)*
...
The list of full Amazon Resource Name (ARN) entries for each cluster thatâs associated with your account.
