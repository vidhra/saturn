...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/secretsmanager/untag-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/secretsmanager/untag-resource.html)*
...
A list of tag key names to remove from the secret. You donât specify the value. Both the key and its associated value are removed.
