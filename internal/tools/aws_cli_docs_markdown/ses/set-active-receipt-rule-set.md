# set-active-receipt-rule-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/set-active-receipt-rule-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/set-active-receipt-rule-set.html)*
