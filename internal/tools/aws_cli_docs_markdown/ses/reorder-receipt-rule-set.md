# reorder-receipt-rule-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/reorder-receipt-rule-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/reorder-receipt-rule-set.html)*
...
All of the rules in the rule set must be represented in this request. That is, it is error if the reorder request doesnât explicitly position all of the rules.
...
The specified receipt rule setâs receipt rules, in order.
