...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/list-integrations.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/list-integrations.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/logs-2014-03-28/ListIntegrations)

## Synopsis

```
list-integrations
[--integration-name-prefix <value>]
...
`--integration-name-prefix` (string)
