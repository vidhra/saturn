# describe-subscription-filtersÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/describe-subscription-filters.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/describe-subscription-filters.html)*
...
The prefix to match. If you donât specify a value, no prefix filter is applied.
