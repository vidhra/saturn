# notify-provision-product-engine-workflow-resultÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/notify-provision-product-engine-workflow-result.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/notify-provision-product-engine-workflow-result.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/servicecatalog-2015-12-10/NotifyProvisionProductEngineWorkflowResult)
...
A unique key thatâs attached to a resource.

Value -> (string)

A unique value thatâs attached to a resource.

Shorthand Syntax:

```
UniqueTag={Key=string,Value=string}
```
