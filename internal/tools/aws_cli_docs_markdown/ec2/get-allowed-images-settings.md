# get-allowed-images-settingsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-allowed-images-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-allowed-images-settings.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/GetAllowedImagesSettings)
...
- `declarative-policy` - The Allowed AMIs settings is managed by a declarative policy and canât be modified by the account.