# get-console-screenshotÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-console-screenshot.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-console-screenshot.html)*
...
When set to `true` , acts as keystroke input and wakes up an instance thatâs in standby or âsleepâ mode.
