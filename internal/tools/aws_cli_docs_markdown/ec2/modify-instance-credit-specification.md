# modify-instance-credit-specificationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-instance-credit-specification.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-instance-credit-specification.html)*
...
This example modifies the credit option for CPU usage of the specified instance in the specified region to âunlimitedâ. Valid credit options are âstandardâ and âunlimitedâ.
