...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/export-image.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/export-image.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ExportImage)
...
The name of the role that grants VM Import/Export permission to export images to your Amazon S3 bucket. If this parameter is not specified, the default role is named âvmimportâ.
