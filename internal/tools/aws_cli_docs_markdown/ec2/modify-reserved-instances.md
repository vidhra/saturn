# modify-reserved-instancesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-reserved-instances.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-reserved-instances.html)*
...
```
AvailabilityZone=string,InstanceCount=integer,InstanceType=string,Platform=string,Scope=string,AvailabilityZoneId=string ...
```
...
For more information, see [Modifying Your Reserved Instances](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-modifying.html) in the *Amazon EC2 User Guide*.
...
For more information, see [Modifying the Instance Size of Your Reservations](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-modification-instancemove.html) in the *Amazon EC2 User Guide*.
