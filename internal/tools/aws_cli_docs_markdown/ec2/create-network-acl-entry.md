# create-network-acl-entryÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-network-acl-entry.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-network-acl-entry.html)*
...
We recommend that you leave room between the rule numbers (for example, 100, 110, 120, â¦), and not number them one right after the other (for example, 101, 102, 103, â¦). This makes it easier to add a rule between existing ones without having to renumber the rules.

After you add an entry, you canât modify it; you must either replace it, or create an entry and delete the old one.
