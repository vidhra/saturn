...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-ipam-scope.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-ipam-scope.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateIpamScope)
...
The ID of the IPAM for which youâre creating this scope.

`--description` (string)

A description for the scope youâre creating.
