...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/wait/vpc-available.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/wait/vpc-available.html)*
...
`vpc-available` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
