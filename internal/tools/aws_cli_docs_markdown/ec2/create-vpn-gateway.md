...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-vpn-gateway.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-vpn-gateway.html)*
...
A private Autonomous System Number (ASN) for the Amazon side of a BGP session. If youâre using a 16-bit ASN, it must be in the 64512 to 65534 range. If youâre using a 32-bit ASN, it must be in the 4200000000 to 4294967294 range.
