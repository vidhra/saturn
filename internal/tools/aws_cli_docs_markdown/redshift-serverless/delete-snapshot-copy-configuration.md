# delete-snapshot-copy-configurationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-serverless/delete-snapshot-copy-configuration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-serverless/delete-snapshot-copy-configuration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/redshift-serverless-2021-04-21/DeleteSnapshotCopyConfiguration)

## Synopsis

```
delete-snapshot-copy-configuration
--snapshot-copy-configuration-id <value>
...
`--snapshot-copy-configuration-id` (string)
