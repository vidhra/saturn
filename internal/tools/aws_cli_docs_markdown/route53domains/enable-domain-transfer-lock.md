# enable-domain-transfer-lockÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53domains/enable-domain-transfer-lock.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53domains/enable-domain-transfer-lock.html)*
...
The following `enable-domain-transfer-lock` command  locks the specified domain so that it canât be transferred to another registrar. This command changes the `clientTransferProhibited` status.
