# cancel-domain-transfer-to-another-aws-accountÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53domains/cancel-domain-transfer-to-another-aws-account.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53domains/cancel-domain-transfer-to-another-aws-account.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/route53domains-2014-05-15/CancelDomainTransferToAnotherAwsAccount)
...
The identifier that `TransferDomainToAnotherAwsAccount` returned to track the progress of the request. Because the transfer request was canceled, the value is no longer valid, and you canât use `GetOperationDetail` to query the operation status.