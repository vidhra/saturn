# resend-contact-reachability-emailÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53domains/resend-contact-reachability-email.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53domains/resend-contact-reachability-email.html)*
...
`True` if the email address for the registrant contact has already been verified, and `false` otherwise. If the email address has already been verified, we donât send another confirmation email.