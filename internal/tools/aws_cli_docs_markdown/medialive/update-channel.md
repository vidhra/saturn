...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/update-channel.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/update-channel.html)*
...
`--destinations` (list)
A list of output destinations for this channel.(structure)
...
The encoder settings for this channel.AudioDescriptions -> (list)
...
Placeholder documentation for __listOfInputAttachment(structure)
...
```
MaintenanceDay=string,MaintenanceScheduledDate=string,MaintenanceStartTime=string
```
...
Channel engine version for this channelVersion -> (string)
