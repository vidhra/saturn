# update-input-security-groupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/update-input-security-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/update-input-security-group.html)*
...
Update an Input Security Groupâs Whilelists.
...
`--whitelist-rules` (list)
List of IPv4 CIDR addresses to whitelist(structure)
