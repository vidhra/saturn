# restart-channel-pipelinesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/restart-channel-pipelines.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/restart-channel-pipelines.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/RestartChannelPipelines)
...
`--pipeline-ids` (list)
An array of pipelines to restart in this channel. Format PIPELINE_0 or PIPELINE_1.(string)
