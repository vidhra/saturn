# create-node-registration-scriptÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/create-node-registration-script.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/create-node-registration-script.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/CreateNodeRegistrationScript)
...
`--id` (string)
If youâre generating a re-registration script for an already existing node, this is where you provide the id.
