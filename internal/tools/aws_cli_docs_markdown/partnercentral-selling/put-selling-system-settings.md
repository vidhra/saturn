# put-selling-system-settingsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/partnercentral-selling/put-selling-system-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/partnercentral-selling/put-selling-system-settings.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/partnercentral-selling-2022-07-26/PutSellingSystemSettings)
...
put-selling-system-settings
--catalog <value>
[--resource-snapshot-job-role-identifier <value>]
...
`--resource-snapshot-job-role-identifier` (string)
