# get-resource-snapshot-jobÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/partnercentral-selling/get-resource-snapshot-job.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/partnercentral-selling/get-resource-snapshot-job.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/partnercentral-selling-2022-07-26/GetResourceSnapshotJob)
...
The date and time when the snapshot job was created in ISO 8601 format (UTC). Example: â2023-05-01T20:37:46Zâ
...
The date and time of the last successful execution of the job, in ISO 8601 format (UTC). Example: â2023-05-01T20:37:46Zâ
...
The type of resource being snapshotted. This would have âOpportunityâ as a value as it is dependent on the supported resource type.
