...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/create-destination.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/create-destination.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iot-managed-integrations-2025-03-03/CreateDestination)
...
--delivery-destination-type <value>
--name <value>
--role-arn <value>
[--client-token <value>]
[--description <value>]
...
`--delivery-destination-type` (string)
