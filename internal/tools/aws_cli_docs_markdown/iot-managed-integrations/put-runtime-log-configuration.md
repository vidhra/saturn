# put-runtime-log-configurationÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/put-runtime-log-configuration.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/put-runtime-log-configuration.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/iot-managed-integrations-2025-03-03/PutRuntimeLogConfiguration)
...
--runtime-log-configurations <value>
...
`--runtime-log-configurations` (structure)
...
```
LogLevel=string,LogFlushLevel=string,LocalStoreLocation=string,LocalStoreFileRotationMaxFiles=integer,LocalStoreFileRotationMaxBytes=integer,UploadLog=boolean,UploadPeriodMinutes=integer,DeleteLocalStoreAfterUpload=boolean
```
