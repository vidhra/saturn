# disassociate-drt-roleÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/disassociate-drt-role.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/disassociate-drt-role.html)*
...
Removes the Shield Response Teamâs (SRT) access to your Amazon Web Services account.
