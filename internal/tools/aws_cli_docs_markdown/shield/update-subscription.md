# update-subscriptionÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/update-subscription.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/update-subscription.html)*
...
For accounts that are members of an Organizations organization, Shield Advanced subscriptions are billed against the organizationâs payer account, regardless of whether the payer account itself is subscribed.
...
**To modify the accountâs AWS Shield Advanced subscription**
