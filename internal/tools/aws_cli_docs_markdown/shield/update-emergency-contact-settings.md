# update-emergency-contact-settingsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/update-emergency-contact-settings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/update-emergency-contact-settings.html)*
...
The following `update-emergency-contact-settings` example defines two e-mail addresses that the DRT should contact when itâs responding to a suspected attack.
