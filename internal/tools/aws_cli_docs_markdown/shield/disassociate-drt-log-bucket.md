# disassociate-drt-log-bucketÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/disassociate-drt-log-bucket.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/disassociate-drt-log-bucket.html)*
...
Removes the Shield Response Teamâs (SRT) access to the specified Amazon S3 bucket containing the logs that you shared previously.
