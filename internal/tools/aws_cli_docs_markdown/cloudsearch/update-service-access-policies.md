# update-service-access-policiesÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/update-service-access-policies.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/update-service-access-policies.html)*
...
Configures the access rules that control access to the domainâs document and search endpoints. For more information, see [Configuring Access for an Amazon CloudSearch Domain](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-access.html) .
