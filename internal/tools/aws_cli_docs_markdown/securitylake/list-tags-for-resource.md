...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securitylake/list-tags-for-resource.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securitylake/list-tags-for-resource.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/securitylake-2018-05-10/ListTagsForResource)
...
The following `list-tags-for-resource` example lists tags for the specified Amazon Security Lake subscriber. In this example, the Owner tag key doesnât have an associated tag value. You can use this operation to list tags for other existing Security Lake resources as well.
...
An array of objects, one for each tag (key and value) thatâs associated with the Amazon Security Lake resource.
