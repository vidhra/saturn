# create-trusted-token-issuerÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/create-trusted-token-issuer.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/create-trusted-token-issuer.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/sso-admin-2020-07-20/CreateTrustedTokenIssuer)
...
```
OidcJwtConfiguration={IssuerUrl=string,ClaimAttributePath=string,IdentityStoreAttributePath=string,JwksRetrievalOption=string}
```
