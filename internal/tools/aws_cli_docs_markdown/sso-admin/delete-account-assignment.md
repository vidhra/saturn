# delete-account-assignmentÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/delete-account-assignment.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/delete-account-assignment.html)*
...
Deletes a principalâs access from a specified Amazon Web Services account using a specified permission set.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/sso-admin-2020-07-20/DeleteAccountAssignment)
