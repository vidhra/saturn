# detach-managed-policy-from-permission-setÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/detach-managed-policy-from-permission-set.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/detach-managed-policy-from-permission-set.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/sso-admin-2020-07-20/DetachManagedPolicyFromPermissionSet)
