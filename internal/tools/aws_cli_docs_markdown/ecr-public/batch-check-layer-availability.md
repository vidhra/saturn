# batch-check-layer-availabilityÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr-public/batch-check-layer-availability.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr-public/batch-check-layer-availability.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/ecr-public-2020-10-30/BatchCheckLayerAvailability)
...
The name of the repository thatâs associated with the image layers to check.
...
The layer digest thatâs associated with the failure.

failureCode -> (string)

The failure code thatâs associated with the failure.
