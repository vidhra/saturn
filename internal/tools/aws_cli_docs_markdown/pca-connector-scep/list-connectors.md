...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pca-connector-scep/list-connectors.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pca-connector-scep/list-connectors.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/pca-connector-scep-2018-05-10/ListConnectors)
...
The Amazon Resource Name (ARN) of the connectorâs associated certificate authority.
...
The connectorâs status. Status can be creating, active, deleting, or failed.
