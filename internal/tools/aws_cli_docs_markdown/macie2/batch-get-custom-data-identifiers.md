# batch-get-custom-data-identifiersÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/batch-get-custom-data-identifiers.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/batch-get-custom-data-identifiers.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/BatchGetCustomDataIdentifiers)
...
An array of custom data identifier IDs, one for each custom data identifier that was specified in the request but doesnât correlate to an existing custom data identifier.
