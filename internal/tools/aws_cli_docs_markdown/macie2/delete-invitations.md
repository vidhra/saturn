...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/delete-invitations.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/delete-invitations.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/DeleteInvitations)
...
An array of objects, one for each account whose invitation hasnât been deleted. Each object identifies the account and explains why the request hasnât been processed for that account.
