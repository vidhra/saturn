...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/update-allow-list.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/update-allow-list.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/UpdateAllowList)
...
You can change a listâs underlying criteria, such as the name of the S3 object or the regular expression to use. However, you canât change the type from s3WordsList to regex or the other way around.
