# list-resource-profile-artifactsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/list-resource-profile-artifacts.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/list-resource-profile-artifacts.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/ListResourceProfileArtifacts)

`list-resource-profile-artifacts` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
...
- SKIPPED - Macie wasnât able to analyze the object. For example, the object is a malformed file.
