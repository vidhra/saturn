...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeguruprofiler/post-agent-profile.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeguruprofiler/post-agent-profile.html)*
...
Submits profiling data to an aggregated profile of a profiling group. To get an aggregated profile that is created with this profiling data, use ` `GetProfile` [https://docs.aws.amazon.com/codeguru/latest/profiler-api/API_GetProfile](https://docs.aws.amazon.com/codeguru/latest/profiler-api/API_GetProfile).html`__ .

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/codeguruprofiler-2019-07-18/PostAgentProfile)
