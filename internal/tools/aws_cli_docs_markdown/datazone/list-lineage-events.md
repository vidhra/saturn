# list-lineage-eventsÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-lineage-events.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-lineage-events.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/ListLineageEvents)

`list-lineage-events` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
...
eventSummary -> (tagged union structure)

The summary of the data lineate event.

### Note

This is a Tagged Union structure. Only one of the following top level keys can be set: `openLineageRunEventSummary`.

openLineageRunEventSummary -> (structure)
