# create-subscription-requestÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/create-subscription-request.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/create-subscription-request.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/CreateSubscriptionRequest)
...
[--metadata-forms <value>]
--request-reason <value>
--subscribed-listings <value>
--subscribed-principals <value>
