# list-lineage-node-historyÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-lineage-node-history.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-lineage-node-history.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/ListLineageNodeHistory)

`list-lineage-node-history` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
...
[--event-timestamp-gte <value>]
[--event-timestamp-lte <value>]
--identifier <value>
[--sort-order <value>]
