# remove-entity-ownerÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/remove-entity-owner.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/remove-entity-owner.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/RemoveEntityOwner)
...
```
group={groupIdentifier=string},user={userIdentifier=string}
```
