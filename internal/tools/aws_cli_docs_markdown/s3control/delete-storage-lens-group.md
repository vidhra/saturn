# delete-storage-lens-groupÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/delete-storage-lens-group.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/delete-storage-lens-group.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/DeleteStorageLensGroup)
...
The name of the Storage Lens group that youâre trying to delete.

`--account-id` (string)

The Amazon Web Services account ID used to create the Storage Lens group that youâre trying to delete.
