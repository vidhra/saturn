# select-aggregate-resource-configÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/select-aggregate-resource-config.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/select-aggregate-resource-config.html)*
...
For more information about query components, see the ` **Query Components** [https://docs.aws.amazon.com/config/latest/developerguide/query-components](https://docs.aws.amazon.com/config/latest/developerguide/query-components).html`__ section in the *Config Developer Guide* .
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/SelectAggregateResourceConfig)

`select-aggregate-resource-config` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
