# put-service-linked-configuration-recorderÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/put-service-linked-configuration-recorder.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/put-service-linked-configuration-recorder.html)*
...
The configuration recorderâs `name` , `recordingGroup` , `recordingMode` , and `recordingScope` is set by the service that is linked to the configuration recorder.
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/PutServiceLinkedConfigurationRecorder)
...
For service-linked configuration recorders, Config automatically assigns a name that has the prefix â`AWS` â to the new service-linked configuration recorder.