...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconnect/purchase-offering.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconnect/purchase-offering.html)*
...
Submits a request to purchase an offering. If you already have an active reservation, you canât purchase another offering.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/PurchaseOffering)
