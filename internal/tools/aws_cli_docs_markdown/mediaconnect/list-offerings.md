...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconnect/list-offerings.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconnect/list-offerings.html)*
...
Displays a list of all offerings that are available to this account in the current Amazon Web Services Region. If you have an active reservation (which means youâve purchased an offering that has already started and hasnât expired yet), your account isnât eligible for other offerings.

See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/ListOfferings)
