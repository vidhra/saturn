...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/list-dataset-entries.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/list-dataset-entries.html)*
...
See also: [AWS API Documentation](https://docs.aws.amazon.com/goto/WebAPI/rekognition-2016-06-27/ListDatasetEntries)
...
Specify `true` to get only the JSON Lines where the image is labeled. Specify `false` to get only the JSON Lines where the image isnât labeled. If you donât specify `Labeled` , `ListDatasetEntries` returns JSON Lines for labeled and unlabeled images.
