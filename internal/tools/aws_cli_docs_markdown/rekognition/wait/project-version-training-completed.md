# project-version-training-completedÂ¶

*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/wait/project-version-training-completed.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/wait/project-version-training-completed.html)*
...
`project-version-training-completed` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the `--no-paginate` argument.
