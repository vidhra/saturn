...
*Source: [https://awscli.amazonaws.com/v2/documentation/api/latest/reference/machinelearning/wait/ml-model-available.html](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/machinelearning/wait/ml-model-available.html)*
...
- `Name` - Sets the search criteria to the contents of `MLModel` [**](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/machinelearning/wait/ml-model-available.html#id1)**  `Name` .
