# gcloud beta access-context-manager policies set-iam-policy  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/beta/access-context-manager/policies/set-iam-policy](https://cloud.google.com/sdk/gcloud/reference/beta/access-context-manager/policies/set-iam-policy)*
...
: **`gcloud beta access-context-manager policies set-iam-policy` [`[POLICY](https://cloud.google.com/sdk/gcloud/reference/beta/access-context-manager/policies/set-iam-policy#POLICY)`] `[POLICY_FILE](https://cloud.google.com/sdk/gcloud/reference/beta/access-context-manager/policies/set-iam-policy#POLICY_FILE)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/beta/access-context-manager/policies/set-iam-policy#GCLOUD-WIDE-FLAGS) …`]**

**DESCRIPTION**

: `(BETA)` Sets the IAM policy for a access policy, given access policy
