# gcloud compute storage-pools describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/compute/storage-pools/describe](https://cloud.google.com/sdk/gcloud/reference/compute/storage-pools/describe)*
...
: **`gcloud compute storage-pools describe` (`[STORAGE_POOL](https://cloud.google.com/sdk/gcloud/reference/compute/storage-pools/describe#STORAGE_POOL)` : `[--zone](https://cloud.google.com/sdk/gcloud/reference/compute/storage-pools/describe#--zone)`=`ZONE`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/compute/storage-pools/describe#GCLOUD-WIDE-FLAGS) …`]**
