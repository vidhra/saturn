# gcloud compute snapshot-settings describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/compute/snapshot-settings/describe](https://cloud.google.com/sdk/gcloud/reference/compute/snapshot-settings/describe)*
...
: **`gcloud compute snapshot-settings describe` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/compute/snapshot-settings/describe#GCLOUD-WIDE-FLAGS) …`]**
