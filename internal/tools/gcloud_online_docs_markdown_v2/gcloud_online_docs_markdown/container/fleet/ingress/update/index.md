# gcloud container fleet ingress update  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/update](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/update)*
...
: **`gcloud container fleet ingress update` [`[--config-membership](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/update#--config-membership)`=`CONFIG_MEMBERSHIP` : `[--location](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/update#--location)`=`LOCATION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/update#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud container fleet ingress update --config-membership=CONFIG_MEMBERSHIP
```
