# gcloud container aws node-pools describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/container/aws/node-pools/describe](https://cloud.google.com/sdk/gcloud/reference/container/aws/node-pools/describe)*
...
: **`gcloud container aws node-pools describe` (`[NODE_POOL](https://cloud.google.com/sdk/gcloud/reference/container/aws/node-pools/describe#NODE_POOL)` : `[--cluster](https://cloud.google.com/sdk/gcloud/reference/container/aws/node-pools/describe#--cluster)`=`CLUSTER` `[--location](https://cloud.google.com/sdk/gcloud/reference/container/aws/node-pools/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/container/aws/node-pools/describe#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud container aws node-pools describe my-node-pool --cluster=my-cluster --location=us-west1
```
