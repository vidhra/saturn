# gcloud container aws clusters delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/container/aws/clusters/delete](https://cloud.google.com/sdk/gcloud/reference/container/aws/clusters/delete)*
...
**--ignore-errors**:
Force delete an AWS cluster. Deletion of the AWS cluster will succeed even if
errors occur during deleting in-cluster resources. Using this parameter may
