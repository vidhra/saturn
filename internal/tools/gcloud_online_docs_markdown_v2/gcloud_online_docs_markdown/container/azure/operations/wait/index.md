# gcloud container azure operations wait  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/container/azure/operations/wait](https://cloud.google.com/sdk/gcloud/reference/container/azure/operations/wait)*
...
: **`gcloud container azure operations wait` (`[OPERATION_ID](https://cloud.google.com/sdk/gcloud/reference/container/azure/operations/wait#OPERATION_ID)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/container/azure/operations/wait#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/container/azure/operations/wait#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud container azure operations wait OPERATION_ID --location=us-west1
```
