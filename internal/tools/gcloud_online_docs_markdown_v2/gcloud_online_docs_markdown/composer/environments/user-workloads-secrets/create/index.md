# gcloud composer environments user-workloads-secrets create  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/composer/environments/user-workloads-secrets/create](https://cloud.google.com/sdk/gcloud/reference/composer/environments/user-workloads-secrets/create)*
...
```
gcloud composer environments user-workloads-secrets create --environment=env-1 --secret-file-path=secret.yaml
```
