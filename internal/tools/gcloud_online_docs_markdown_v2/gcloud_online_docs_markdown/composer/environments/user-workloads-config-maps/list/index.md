# gcloud composer environments user-workloads-config-maps list  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/composer/environments/user-workloads-config-maps/list](https://cloud.google.com/sdk/gcloud/reference/composer/environments/user-workloads-config-maps/list)*
...
```
gcloud composer environments user-workloads-config-maps list --environment=env-1
```
