# gcloud artifacts print-settings mvn  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/mvn](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/mvn)*
...
: **`gcloud artifacts print-settings mvn` [`[--json-key](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/mvn#--json-key)`=`JSON_KEY`] [`[--location](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/mvn#--location)`=`LOCATION` `[--repository](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/mvn#--repository)`=`REPOSITORY`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/mvn#GCLOUD-WIDE-FLAGS) …`]**
