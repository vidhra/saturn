# gcloud artifacts vpcsc-config deny  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/artifacts/vpcsc-config/deny](https://cloud.google.com/sdk/gcloud/reference/artifacts/vpcsc-config/deny)*
...
: **`gcloud artifacts vpcsc-config deny` [`[--location](https://cloud.google.com/sdk/gcloud/reference/artifacts/vpcsc-config/deny#--location)`=`LOCATION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/vpcsc-config/deny#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud artifacts vpcsc-config deny --project=my-project --location=us-west1
```
