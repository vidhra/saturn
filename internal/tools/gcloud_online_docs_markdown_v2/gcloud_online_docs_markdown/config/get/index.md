# gcloud config get  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/config/get](https://cloud.google.com/sdk/gcloud/reference/config/get)*

**NAME**

: **gcloud config get - print the value of a Google Cloud CLI property**

**SYNOPSIS**

: **`gcloud config get` `[SECTION](https://cloud.google.com/sdk/gcloud/reference/config/get#SECTION)`/`[PROPERTY](https://cloud.google.com/sdk/gcloud/reference/config/get#PROPERTY)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/config/get#GCLOUD-WIDE-FLAGS) …`]**
