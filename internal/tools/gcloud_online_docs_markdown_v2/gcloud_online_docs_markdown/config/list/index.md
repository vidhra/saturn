# gcloud config list  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/config/list](https://cloud.google.com/sdk/gcloud/reference/config/list)*
...
: **`gcloud config list` [`[SECTION](https://cloud.google.com/sdk/gcloud/reference/config/list#SECTION)`/`[PROPERTY](https://cloud.google.com/sdk/gcloud/reference/config/list#PROPERTY)`] [`[--all](https://cloud.google.com/sdk/gcloud/reference/config/list#--all)`] [`[--filter](https://cloud.google.com/sdk/gcloud/reference/config/list#--filter)`=`EXPRESSION`] [`[--limit](https://cloud.google.com/sdk/gcloud/reference/config/list#--limit)`=`LIMIT`] [`[--sort-by](https://cloud.google.com/sdk/gcloud/reference/config/list#--sort-by)`=[`FIELD`,…]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/config/list#GCLOUD-WIDE-FLAGS) …`]**
...
region and zone, if set. See `[gcloud topic
