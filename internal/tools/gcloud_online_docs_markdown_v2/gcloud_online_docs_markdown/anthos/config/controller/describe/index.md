# gcloud anthos config controller describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/anthos/config/controller/describe](https://cloud.google.com/sdk/gcloud/reference/anthos/config/controller/describe)*
...
: **`gcloud anthos config controller describe` (`[NAME](https://cloud.google.com/sdk/gcloud/reference/anthos/config/controller/describe#NAME)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/anthos/config/controller/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/anthos/config/controller/describe#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud anthos config controller describe default --location=us-central1
```
