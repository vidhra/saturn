# gcloud ai-platform operations describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ai-platform/operations/describe](https://cloud.google.com/sdk/gcloud/reference/ai-platform/operations/describe)*
...
: **`gcloud ai-platform operations describe` `[OPERATION](https://cloud.google.com/sdk/gcloud/reference/ai-platform/operations/describe#OPERATION)` [`[--region](https://cloud.google.com/sdk/gcloud/reference/ai-platform/operations/describe#--region)`=`REGION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ai-platform/operations/describe#GCLOUD-WIDE-FLAGS) …`]**
