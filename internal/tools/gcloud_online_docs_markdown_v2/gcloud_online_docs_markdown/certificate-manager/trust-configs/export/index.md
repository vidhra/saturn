# gcloud certificate-manager trust-configs export  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/certificate-manager/trust-configs/export](https://cloud.google.com/sdk/gcloud/reference/certificate-manager/trust-configs/export)*

**NAME**

: **gcloud certificate-manager trust-configs export - export TrustConfig**

**SYNOPSIS**

: **`gcloud certificate-manager trust-configs export` (`[TRUST_CONFIG](https://cloud.google.com/sdk/gcloud/reference/certificate-manager/trust-configs/export#TRUST_CONFIG)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/certificate-manager/trust-configs/export#--location)`=`LOCATION`) [`[--destination](https://cloud.google.com/sdk/gcloud/reference/certificate-manager/trust-configs/export#--destination)`=`DESTINATION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/certificate-manager/trust-configs/export#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud certificate-manager trust-configs export my-trust-config --destination=my-trust-config.yaml --location=global
```
