# gcloud alpha ai-platform models set-iam-policy  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/ai-platform/models/set-iam-policy](https://cloud.google.com/sdk/gcloud/reference/alpha/ai-platform/models/set-iam-policy)*
...
: **`gcloud alpha ai-platform models set-iam-policy` `[MODEL](https://cloud.google.com/sdk/gcloud/reference/alpha/ai-platform/models/set-iam-policy#MODEL)` `[POLICY_FILE](https://cloud.google.com/sdk/gcloud/reference/alpha/ai-platform/models/set-iam-policy#POLICY_FILE)` [`[--region](https://cloud.google.com/sdk/gcloud/reference/alpha/ai-platform/models/set-iam-policy#--region)`=`REGION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/ai-platform/models/set-iam-policy#GCLOUD-WIDE-FLAGS) …`]**

**DESCRIPTION**

: `(ALPHA)` Sets the IAM policy for the given model as defined in a
JSON or YAML file.
