# gcloud alpha bq tables insert  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/bq/tables/insert](https://cloud.google.com/sdk/gcloud/reference/alpha/bq/tables/insert)*
...
: **`gcloud alpha bq tables insert` (`[TABLE](https://cloud.google.com/sdk/gcloud/reference/alpha/bq/tables/insert#TABLE)` : `[--dataset](https://cloud.google.com/sdk/gcloud/reference/alpha/bq/tables/insert#--dataset)`=`DATASET`) `[--data](https://cloud.google.com/sdk/gcloud/reference/alpha/bq/tables/insert#--data)`=`PATH_TO_FILE` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/bq/tables/insert#GCLOUD-WIDE-FLAGS) …`]**
...
: The following command inserts rows from `data_file.json` into
