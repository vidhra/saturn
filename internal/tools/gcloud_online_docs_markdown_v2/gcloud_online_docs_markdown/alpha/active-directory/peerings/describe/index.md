# gcloud alpha active-directory peerings describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/peerings/describe](https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/peerings/describe)*
...
: **`gcloud alpha active-directory peerings describe` `[PEERING](https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/peerings/describe#PEERING)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/peerings/describe#GCLOUD-WIDE-FLAGS) …`]**
