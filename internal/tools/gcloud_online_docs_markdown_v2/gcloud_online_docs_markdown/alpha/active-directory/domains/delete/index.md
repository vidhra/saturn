# gcloud alpha active-directory domains delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/domains/delete](https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/domains/delete)*
...
: **`gcloud alpha active-directory domains delete` `[DOMAIN](https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/domains/delete#DOMAIN)` [`[--async](https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/domains/delete#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/active-directory/domains/delete#GCLOUD-WIDE-FLAGS) …`]**

**DESCRIPTION**

: `(ALPHA)` Delete a managed Microsoft Active Directory (AD) domain
with the given fully-qualified domain name.
