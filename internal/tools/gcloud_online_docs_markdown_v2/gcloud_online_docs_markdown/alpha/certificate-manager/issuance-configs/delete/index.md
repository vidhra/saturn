# gcloud alpha certificate-manager issuance-configs delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/certificate-manager/issuance-configs/delete](https://cloud.google.com/sdk/gcloud/reference/alpha/certificate-manager/issuance-configs/delete)*

**NAME**

: **gcloud alpha certificate-manager issuance-configs delete - delete a Certificate Issuance Config**

**SYNOPSIS**

: **`gcloud alpha certificate-manager issuance-configs delete` (`[CERTIFICATE_ISSUANCE_CONFIG](https://cloud.google.com/sdk/gcloud/reference/alpha/certificate-manager/issuance-configs/delete#CERTIFICATE_ISSUANCE_CONFIG)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/alpha/certificate-manager/issuance-configs/delete#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/alpha/certificate-manager/issuance-configs/delete#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/certificate-manager/issuance-configs/delete#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud alpha certificate-manager issuance-configs delete my-cic
```

**POSITIONAL ARGUMENTS**

: **CertificateIssuanceConfig resource - Name of the CertificateIssuanceConfig to
