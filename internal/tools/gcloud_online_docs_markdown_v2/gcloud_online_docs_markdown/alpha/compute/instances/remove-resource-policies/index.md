# gcloud alpha compute instances remove-resource-policies  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/remove-resource-policies](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/remove-resource-policies)*
...
: **`gcloud alpha compute instances remove-resource-policies` `[INSTANCE_NAME](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/remove-resource-policies#INSTANCE_NAME)` `[--resource-policies](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/remove-resource-policies#--resource-policies)`=[`RESOURCE_POLICY`,…] [`[--zone](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/remove-resource-policies#--zone)`=`ZONE`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/remove-resource-policies#GCLOUD-WIDE-FLAGS) …`]**

**DESCRIPTION**

: `(ALPHA)` `gcloud alpha compute instances
remove-resource-policies` removes resource policies from Compute Engine
virtual instances.
