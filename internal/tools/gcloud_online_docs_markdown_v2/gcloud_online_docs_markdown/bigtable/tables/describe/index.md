# gcloud bigtable tables describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/describe](https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/describe)*
...
: **`gcloud bigtable tables describe` (`[TABLE](https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/describe#TABLE)` : `[--instance](https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/describe#--instance)`=`INSTANCE`) [`[--view](https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/describe#--view)`=`VIEW`; default="schema"] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/describe#GCLOUD-WIDE-FLAGS) …`]**
