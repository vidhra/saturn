# gcloud batch jobs describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/batch/jobs/describe](https://cloud.google.com/sdk/gcloud/reference/batch/jobs/describe)*
...
: **`gcloud batch jobs describe` (`[JOB](https://cloud.google.com/sdk/gcloud/reference/batch/jobs/describe#JOB)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/batch/jobs/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/batch/jobs/describe#GCLOUD-WIDE-FLAGS) …`]**
