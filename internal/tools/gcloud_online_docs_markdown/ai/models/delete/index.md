# gcloud ai models delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ai/models/delete](https://cloud.google.com/sdk/gcloud/reference/ai/models/delete)*
...
: **`gcloud ai models delete` (`[MODEL](https://cloud.google.com/sdk/gcloud/reference/ai/models/delete#MODEL)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/ai/models/delete#--region)`=`REGION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ai/models/delete#GCLOUD-WIDE-FLAGS) …`]**
