# gcloud ai indexes delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ai/indexes/delete](https://cloud.google.com/sdk/gcloud/reference/ai/indexes/delete)*
...
: **`gcloud ai indexes delete` (`[INDEX](https://cloud.google.com/sdk/gcloud/reference/ai/indexes/delete#INDEX)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/ai/indexes/delete#--region)`=`REGION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ai/indexes/delete#GCLOUD-WIDE-FLAGS) …`]**
