# gcloud ai endpoints raw-predict  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ai/endpoints/raw-predict](https://cloud.google.com/sdk/gcloud/reference/ai/endpoints/raw-predict)*
...
: **`gcloud ai endpoints raw-predict` (`[ENDPOINT](https://cloud.google.com/sdk/gcloud/reference/ai/endpoints/raw-predict#ENDPOINT)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/ai/endpoints/raw-predict#--region)`=`REGION`) `[--request](https://cloud.google.com/sdk/gcloud/reference/ai/endpoints/raw-predict#--request)`=`REQUEST` [`[--http-headers](https://cloud.google.com/sdk/gcloud/reference/ai/endpoints/raw-predict#--http-headers)`=[`HEADER`=`VALUE`,…]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ai/endpoints/raw-predict#GCLOUD-WIDE-FLAGS) …`]**
