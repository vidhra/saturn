# gcloud pubsub lite-topics delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/pubsub/lite-topics/delete](https://cloud.google.com/sdk/gcloud/reference/pubsub/lite-topics/delete)*
...
: **`gcloud pubsub lite-topics delete` (`[TOPIC](https://cloud.google.com/sdk/gcloud/reference/pubsub/lite-topics/delete#TOPIC)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/pubsub/lite-topics/delete#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/pubsub/lite-topics/delete#GCLOUD-WIDE-FLAGS) …`]**
