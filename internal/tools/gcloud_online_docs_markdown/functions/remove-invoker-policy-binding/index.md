# gcloud functions remove-invoker-policy-binding  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/functions/remove-invoker-policy-binding](https://cloud.google.com/sdk/gcloud/reference/functions/remove-invoker-policy-binding)*
...
: **`gcloud functions remove-invoker-policy-binding` (`[NAME](https://cloud.google.com/sdk/gcloud/reference/functions/remove-invoker-policy-binding#NAME)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/functions/remove-invoker-policy-binding#--region)`=`REGION`) `[--member](https://cloud.google.com/sdk/gcloud/reference/functions/remove-invoker-policy-binding#--member)`=`PRINCIPAL` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/functions/remove-invoker-policy-binding#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud functions remove-invoker-policy-binding FUNCTION-1 --member=MEMBER-1
```
