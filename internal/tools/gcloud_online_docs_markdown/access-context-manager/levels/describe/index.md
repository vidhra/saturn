# gcloud access-context-manager levels describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/access-context-manager/levels/describe](https://cloud.google.com/sdk/gcloud/reference/access-context-manager/levels/describe)*
...
: **`gcloud access-context-manager levels describe` (`[LEVEL](https://cloud.google.com/sdk/gcloud/reference/access-context-manager/levels/describe#LEVEL)` : `[--policy](https://cloud.google.com/sdk/gcloud/reference/access-context-manager/levels/describe#--policy)`=`POLICY`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/access-context-manager/levels/describe#GCLOUD-WIDE-FLAGS) …`]**
