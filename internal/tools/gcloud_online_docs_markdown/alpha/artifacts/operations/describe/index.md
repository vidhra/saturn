# gcloud alpha artifacts operations describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/operations/describe](https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/operations/describe)*
...
: **`gcloud alpha artifacts operations describe` (`[OPERATION](https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/operations/describe#OPERATION)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/operations/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/operations/describe#GCLOUD-WIDE-FLAGS) …`]**

**DESCRIPTION**

: `(ALPHA)` Describe an Artifact Registry operation given the operation
id.
