# gcloud alpha artifacts vpcsc-config describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/vpcsc-config/describe](https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/vpcsc-config/describe)*
...
: **`gcloud alpha artifacts vpcsc-config describe` [`[--location](https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/vpcsc-config/describe#--location)`=`LOCATION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/artifacts/vpcsc-config/describe#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud alpha artifacts vpcsc-config describe --project=my-project --location=us-west1
```
