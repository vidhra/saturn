# gcloud alpha builds cancel  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/builds/cancel](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/cancel)*
...
: **`gcloud alpha builds cancel` `[BUILDS](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/cancel#BUILDS)` [`[BUILDS](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/cancel#BUILDS)` …] [`[--region](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/cancel#--region)`=`REGION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/cancel#GCLOUD-WIDE-FLAGS) …`]**
