# gcloud alpha builds log  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/builds/log](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/log)*
...
: **`gcloud alpha builds log` `[BUILD](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/log#BUILD)` [`[--region](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/log#--region)`=`REGION`] [`[--stream](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/log#--stream)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/builds/log#GCLOUD-WIDE-FLAGS) …`]**
