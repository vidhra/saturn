# gcloud alpha compute instances export  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/export](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/export)*
...
: **`gcloud alpha compute instances export` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/export#INSTANCE)` : `[--zone](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/export#--zone)`=`ZONE`) [`[--destination](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/export#--destination)`=`DESTINATION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/export#GCLOUD-WIDE-FLAGS) …`]**
