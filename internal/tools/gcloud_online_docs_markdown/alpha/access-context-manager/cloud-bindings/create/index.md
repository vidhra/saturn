# gcloud alpha access-context-manager cloud-bindings create  |  Google Cloud CLI Documentation
...
To create a new cloud access binding for all service accounts in a particular
project, run:
