# gcloud alpha batch jobs delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/alpha/batch/jobs/delete](https://cloud.google.com/sdk/gcloud/reference/alpha/batch/jobs/delete)*
...
: **`gcloud alpha batch jobs delete` (`[JOB](https://cloud.google.com/sdk/gcloud/reference/alpha/batch/jobs/delete#JOB)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/alpha/batch/jobs/delete#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/alpha/batch/jobs/delete#GCLOUD-WIDE-FLAGS) …`]**
