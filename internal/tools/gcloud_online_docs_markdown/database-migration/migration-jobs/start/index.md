# gcloud database-migration migration-jobs start  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/start](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/start)*
...
: **`gcloud database-migration migration-jobs start` (`[MIGRATION_JOB](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/start#MIGRATION_JOB)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/start#--region)`=`REGION`) [`[--skip-validation](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/start#--skip-validation)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/start#GCLOUD-WIDE-FLAGS) …`]**
