# gcloud database-migration migration-jobs verify  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/verify](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/verify)*
...
: **`gcloud database-migration migration-jobs verify` (`[MIGRATION_JOB](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/verify#MIGRATION_JOB)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/verify#--region)`=`REGION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/verify#GCLOUD-WIDE-FLAGS) …`]**
...
Service migration job to verify. The arguments in this group can be used to
