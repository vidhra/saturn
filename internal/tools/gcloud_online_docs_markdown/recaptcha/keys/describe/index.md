# gcloud recaptcha keys describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/recaptcha/keys/describe](https://cloud.google.com/sdk/gcloud/reference/recaptcha/keys/describe)*
...
: **`gcloud recaptcha keys describe` `[KEY](https://cloud.google.com/sdk/gcloud/reference/recaptcha/keys/describe#KEY)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/recaptcha/keys/describe#GCLOUD-WIDE-FLAGS) …`]**
