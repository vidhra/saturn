# gcloud network-services grpc-routes describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/network-services/grpc-routes/describe](https://cloud.google.com/sdk/gcloud/reference/network-services/grpc-routes/describe)*
...
: **`gcloud network-services grpc-routes describe` (`[GRPC_ROUTE](https://cloud.google.com/sdk/gcloud/reference/network-services/grpc-routes/describe#GRPC_ROUTE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/network-services/grpc-routes/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/network-services/grpc-routes/describe#GCLOUD-WIDE-FLAGS) …`]**
