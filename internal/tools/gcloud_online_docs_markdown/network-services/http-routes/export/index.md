# gcloud network-services http-routes export  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/network-services/http-routes/export](https://cloud.google.com/sdk/gcloud/reference/network-services/http-routes/export)*
...
: **`gcloud network-services http-routes export` (`[HTTP_ROUTE](https://cloud.google.com/sdk/gcloud/reference/network-services/http-routes/export#HTTP_ROUTE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/network-services/http-routes/export#--location)`=`LOCATION`) [`[--destination](https://cloud.google.com/sdk/gcloud/reference/network-services/http-routes/export#--destination)`=`DESTINATION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/network-services/http-routes/export#GCLOUD-WIDE-FLAGS) …`]**
