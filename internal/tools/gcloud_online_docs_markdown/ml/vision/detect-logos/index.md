# gcloud ml vision detect-logos  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-logos](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-logos)*

**NAME**

: **gcloud ml vision detect-logos - detect popular product logos within an image**

**SYNOPSIS**

: **`gcloud ml vision detect-logos` `[IMAGE_PATH](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-logos#IMAGE_PATH)` [`[--max-results](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-logos#--max-results)`=`MAX_RESULTS`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-logos#GCLOUD-WIDE-FLAGS) …`]**
