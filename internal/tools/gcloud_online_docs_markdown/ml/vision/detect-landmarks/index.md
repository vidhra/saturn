# gcloud ml vision detect-landmarks  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-landmarks](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-landmarks)*
...
: **`gcloud ml vision detect-landmarks` `[IMAGE_PATH](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-landmarks#IMAGE_PATH)` [`[--max-results](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-landmarks#--max-results)`=`MAX_RESULTS`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ml/vision/detect-landmarks#GCLOUD-WIDE-FLAGS) …`]**
