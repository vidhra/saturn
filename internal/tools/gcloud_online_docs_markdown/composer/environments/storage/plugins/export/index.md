# gcloud composer environments storage plugins export  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/composer/environments/storage/plugins/export](https://cloud.google.com/sdk/gcloud/reference/composer/environments/storage/plugins/export)*
...
: **`gcloud composer environments storage plugins export` `[--destination](https://cloud.google.com/sdk/gcloud/reference/composer/environments/storage/plugins/export#--destination)`=`DESTINATION` (`[--environment](https://cloud.google.com/sdk/gcloud/reference/composer/environments/storage/plugins/export#--environment)`=`ENVIRONMENT` : `[--location](https://cloud.google.com/sdk/gcloud/reference/composer/environments/storage/plugins/export#--location)`=`LOCATION`) [`[--source](https://cloud.google.com/sdk/gcloud/reference/composer/environments/storage/plugins/export#--source)`=`SOURCE`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/composer/environments/storage/plugins/export#GCLOUD-WIDE-FLAGS) …`]**
