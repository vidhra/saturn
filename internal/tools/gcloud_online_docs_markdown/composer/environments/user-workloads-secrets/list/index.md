# gcloud composer environments user-workloads-secrets list  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/composer/environments/user-workloads-secrets/list](https://cloud.google.com/sdk/gcloud/reference/composer/environments/user-workloads-secrets/list)*
...
```
gcloud composer environments user-workloads-secrets list --environment=env-1
```
