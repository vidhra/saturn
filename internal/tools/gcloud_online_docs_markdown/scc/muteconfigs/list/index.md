# gcloud scc muteconfigs list  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list)*
...
: **`gcloud scc muteconfigs list` (`[--folder](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--folder)`=`FOLDER`     | `[--organization](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--organization)`=`ORGANIZATION`     | `[--project](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--project)`=`PROJECT`) [`[--location](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--location)`=`LOCATION`; default="global"] [`[--filter](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--filter)`=`EXPRESSION`] [`[--limit](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--limit)`=`LIMIT`] [`[--page-size](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--page-size)`=`PAGE_SIZE`] [`[--sort-by](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#--sort-by)`=[`FIELD`,…]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/scc/muteconfigs/list#GCLOUD-WIDE-FLAGS) …`]**
