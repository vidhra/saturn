# gcloud workbench instances upgrade  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/workbench/instances/upgrade](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/upgrade)*
...
: **`gcloud workbench instances upgrade` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/upgrade#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/upgrade#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/upgrade#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/upgrade#GCLOUD-WIDE-FLAGS) …`]**
