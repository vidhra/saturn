# gcloud workbench instances reset  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/workbench/instances/reset](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/reset)*
...
: **`gcloud workbench instances reset` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/reset#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/reset#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/reset#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/reset#GCLOUD-WIDE-FLAGS) …`]**
