# gcloud workbench instances describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/workbench/instances/describe](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/describe)*
...
: **`gcloud workbench instances describe` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/describe#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/describe#GCLOUD-WIDE-FLAGS) …`]**
