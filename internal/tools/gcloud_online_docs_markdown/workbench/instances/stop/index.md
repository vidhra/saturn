# gcloud workbench instances stop  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/workbench/instances/stop](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/stop)*
...
: **`gcloud workbench instances stop` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/stop#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/stop#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/stop#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/stop#GCLOUD-WIDE-FLAGS) …`]**
