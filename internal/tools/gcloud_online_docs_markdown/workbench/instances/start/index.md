# gcloud workbench instances start  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/workbench/instances/start](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/start)*
...
: **`gcloud workbench instances start` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/start#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/start#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/start#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/workbench/instances/start#GCLOUD-WIDE-FLAGS) …`]**
