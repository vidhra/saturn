# gcloud gemini operations wait  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/gemini/operations/wait](https://cloud.google.com/sdk/gcloud/reference/gemini/operations/wait)*
...
: **`gcloud gemini operations wait` (`[OPERATION](https://cloud.google.com/sdk/gcloud/reference/gemini/operations/wait#OPERATION)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/gemini/operations/wait#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/gemini/operations/wait#GCLOUD-WIDE-FLAGS) …`]**
