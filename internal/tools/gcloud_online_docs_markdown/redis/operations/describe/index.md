# gcloud redis operations describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/redis/operations/describe](https://cloud.google.com/sdk/gcloud/reference/redis/operations/describe)*
...
: **`gcloud redis operations describe` (`[OPERATION](https://cloud.google.com/sdk/gcloud/reference/redis/operations/describe#OPERATION)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/redis/operations/describe#--region)`=`REGION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/redis/operations/describe#GCLOUD-WIDE-FLAGS) …`]**
...
: To display the metadata for an operation named `my-redis-operation`
