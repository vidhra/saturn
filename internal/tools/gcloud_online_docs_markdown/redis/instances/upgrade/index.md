# gcloud redis instances upgrade  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/redis/instances/upgrade](https://cloud.google.com/sdk/gcloud/reference/redis/instances/upgrade)*

**NAME**

: **gcloud redis instances upgrade - upgrade a Memorystore for Redis instance to a specified Redis version**

**SYNOPSIS**

: **`gcloud redis instances upgrade` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/redis/instances/upgrade#INSTANCE)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/redis/instances/upgrade#--region)`=`REGION`) `[--redis-version](https://cloud.google.com/sdk/gcloud/reference/redis/instances/upgrade#--redis-version)`=`VERSION` [`[--async](https://cloud.google.com/sdk/gcloud/reference/redis/instances/upgrade#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/redis/instances/upgrade#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud redis instances upgrade my-redis-instance --region=us-central1 --redis-version=redis_4_0
```
