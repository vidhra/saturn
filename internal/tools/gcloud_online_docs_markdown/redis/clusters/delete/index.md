# gcloud redis clusters delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/redis/clusters/delete](https://cloud.google.com/sdk/gcloud/reference/redis/clusters/delete)*

**NAME**

: **gcloud redis clusters delete - delete a Memorystore for Redis Cluster instance**

**SYNOPSIS**

: **`gcloud redis clusters delete` (`[CLUSTER](https://cloud.google.com/sdk/gcloud/reference/redis/clusters/delete#CLUSTER)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/redis/clusters/delete#--region)`=`REGION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/redis/clusters/delete#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/redis/clusters/delete#GCLOUD-WIDE-FLAGS) …`]**
...
: To delete a cluster with the name `my-redis-cluster` in your default
region, run:
