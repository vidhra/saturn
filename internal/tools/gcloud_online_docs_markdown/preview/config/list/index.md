# gcloud preview config list  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/preview/config/list](https://cloud.google.com/sdk/gcloud/reference/preview/config/list)*
...
: **`gcloud preview config list` [`[SECTION](https://cloud.google.com/sdk/gcloud/reference/preview/config/list#SECTION)`/`[PROPERTY](https://cloud.google.com/sdk/gcloud/reference/preview/config/list#PROPERTY)`] [`[--all](https://cloud.google.com/sdk/gcloud/reference/preview/config/list#--all)`] [`[--filter](https://cloud.google.com/sdk/gcloud/reference/preview/config/list#--filter)`=`EXPRESSION`] [`[--limit](https://cloud.google.com/sdk/gcloud/reference/preview/config/list#--limit)`=`LIMIT`] [`[--sort-by](https://cloud.google.com/sdk/gcloud/reference/preview/config/list#--sort-by)`=[`FIELD`,…]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/preview/config/list#GCLOUD-WIDE-FLAGS) …`]**

**DESCRIPTION**

: `(PREVIEW)` gcloud preview config list lists the properties of the
specified section using the active configuration. These include the account used
to authorize access to Google Cloud, the current Google Cloud project, and the
default Compute Engine region and zone, if set. See `[gcloud topic
configurations](https://cloud.google.com/sdk/gcloud/reference/topic/configurations)` for more about configurations.
...
Note, you cannot specify both `--all` and a property name. Only a
section name and the `--all` flag can be used together in the format
`gcloud config list <SECTION>/ --all`.
