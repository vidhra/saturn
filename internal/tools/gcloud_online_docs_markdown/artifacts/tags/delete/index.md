# gcloud artifacts tags delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/artifacts/tags/delete](https://cloud.google.com/sdk/gcloud/reference/artifacts/tags/delete)*
...
: **`gcloud artifacts tags delete` (`[TAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/tags/delete#TAG)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/artifacts/tags/delete#--location)`=`LOCATION` `[--package](https://cloud.google.com/sdk/gcloud/reference/artifacts/tags/delete#--package)`=`PACKAGE` `[--repository](https://cloud.google.com/sdk/gcloud/reference/artifacts/tags/delete#--repository)`=`REPOSITORY`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/tags/delete#GCLOUD-WIDE-FLAGS) …`]**
