# gcloud artifacts print-settings gradle  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/gradle](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/gradle)*
...
: **`gcloud artifacts print-settings gradle` [`[--json-key](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/gradle#--json-key)`=`JSON_KEY`] [`[--location](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/gradle#--location)`=`LOCATION` `[--repository](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/gradle#--repository)`=`REPOSITORY`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/print-settings/gradle#GCLOUD-WIDE-FLAGS) …`]**
