# gcloud artifacts settings describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/artifacts/settings/describe](https://cloud.google.com/sdk/gcloud/reference/artifacts/settings/describe)*
...
: **`gcloud artifacts settings describe` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/settings/describe#GCLOUD-WIDE-FLAGS) …`]**
