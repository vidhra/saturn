# gcloud artifacts repositories set-iam-policy  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/artifacts/repositories/set-iam-policy](https://cloud.google.com/sdk/gcloud/reference/artifacts/repositories/set-iam-policy)*
...
: **`gcloud artifacts repositories set-iam-policy` (`[REPOSITORY](https://cloud.google.com/sdk/gcloud/reference/artifacts/repositories/set-iam-policy#REPOSITORY)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/artifacts/repositories/set-iam-policy#--location)`=`LOCATION`) `[POLICY_FILE](https://cloud.google.com/sdk/gcloud/reference/artifacts/repositories/set-iam-policy#POLICY_FILE)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/repositories/set-iam-policy#GCLOUD-WIDE-FLAGS) …`]**
