# gcloud artifacts versions describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/artifacts/versions/describe](https://cloud.google.com/sdk/gcloud/reference/artifacts/versions/describe)*
...
: **`gcloud artifacts versions describe` (`[VERSION](https://cloud.google.com/sdk/gcloud/reference/artifacts/versions/describe#VERSION)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/artifacts/versions/describe#--location)`=`LOCATION` `[--package](https://cloud.google.com/sdk/gcloud/reference/artifacts/versions/describe#--package)`=`PACKAGE` `[--repository](https://cloud.google.com/sdk/gcloud/reference/artifacts/versions/describe#--repository)`=`REPOSITORY`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/artifacts/versions/describe#GCLOUD-WIDE-FLAGS) …`]**
...
: To describe version `1.0.0` of `my-pkg` under the current
