# gcloud edge-cloud container operations wait  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/edge-cloud/container/operations/wait](https://cloud.google.com/sdk/gcloud/reference/edge-cloud/container/operations/wait)*
...
: **`gcloud edge-cloud container operations wait` (`[OPERATION](https://cloud.google.com/sdk/gcloud/reference/edge-cloud/container/operations/wait#OPERATION)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/edge-cloud/container/operations/wait#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/edge-cloud/container/operations/wait#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud edge-cloud container operations wait projects/my-project/locations/us-east1/operations/123
```
