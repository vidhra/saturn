# gcloud compute disks set-iam-policy  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/compute/disks/set-iam-policy](https://cloud.google.com/sdk/gcloud/reference/compute/disks/set-iam-policy)*
...
: **`gcloud compute disks set-iam-policy` (`[DISK](https://cloud.google.com/sdk/gcloud/reference/compute/disks/set-iam-policy#DISK)` : `[--zone](https://cloud.google.com/sdk/gcloud/reference/compute/disks/set-iam-policy#--zone)`=`ZONE`) `[POLICY_FILE](https://cloud.google.com/sdk/gcloud/reference/compute/disks/set-iam-policy#POLICY_FILE)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/compute/disks/set-iam-policy#GCLOUD-WIDE-FLAGS) …`]**
