# gcloud compute tpus describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/compute/tpus/describe](https://cloud.google.com/sdk/gcloud/reference/compute/tpus/describe)*
...
: **`gcloud compute tpus describe` (`[TPU](https://cloud.google.com/sdk/gcloud/reference/compute/tpus/describe#TPU)` : `[--zone](https://cloud.google.com/sdk/gcloud/reference/compute/tpus/describe#--zone)`=`ZONE`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/compute/tpus/describe#GCLOUD-WIDE-FLAGS) …`]**
...
: The following command describes a TPU with ID `my-tpu` in zone
`us-central1-b`:
