# gcloud pam entitlements describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/pam/entitlements/describe](https://cloud.google.com/sdk/gcloud/reference/pam/entitlements/describe)*

**NAME**

: **gcloud pam entitlements describe - show details of a Privileged Access Manager entitlement**

**SYNOPSIS**

: **`gcloud pam entitlements describe` (`[ENTITLEMENT](https://cloud.google.com/sdk/gcloud/reference/pam/entitlements/describe#ENTITLEMENT)` : `[--folder](https://cloud.google.com/sdk/gcloud/reference/pam/entitlements/describe#--folder)`=`FOLDER` `[--location](https://cloud.google.com/sdk/gcloud/reference/pam/entitlements/describe#--location)`=`LOCATION` `[--organization](https://cloud.google.com/sdk/gcloud/reference/pam/entitlements/describe#--organization)`=`ORGANIZATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/pam/entitlements/describe#GCLOUD-WIDE-FLAGS) …`]**
...
: **Entitlement resource - Name of the entitlement to describe. The arguments in
