# gcloud colab runtimes stop  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/colab/runtimes/stop](https://cloud.google.com/sdk/gcloud/reference/colab/runtimes/stop)*
...
: **`gcloud colab runtimes stop` (`[RUNTIME](https://cloud.google.com/sdk/gcloud/reference/colab/runtimes/stop#RUNTIME)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/colab/runtimes/stop#--region)`=`REGION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/colab/runtimes/stop#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/colab/runtimes/stop#GCLOUD-WIDE-FLAGS) …`]**
...
: To stop a runtime with id `my-runtime` in region
`us-central1`, run:
