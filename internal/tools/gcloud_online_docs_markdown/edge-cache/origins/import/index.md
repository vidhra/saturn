# gcloud edge-cache origins import  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/edge-cache/origins/import](https://cloud.google.com/sdk/gcloud/reference/edge-cache/origins/import)*
...
: **`gcloud edge-cache origins import` (`[ORIGIN](https://cloud.google.com/sdk/gcloud/reference/edge-cache/origins/import#ORIGIN)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/edge-cache/origins/import#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/edge-cache/origins/import#--async)`] [`[--source](https://cloud.google.com/sdk/gcloud/reference/edge-cache/origins/import#--source)`=`SOURCE`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/edge-cache/origins/import#GCLOUD-WIDE-FLAGS) …`]**
