# gcloud notebooks runtimes stop  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/stop](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/stop)*

**NAME**

: **gcloud notebooks runtimes stop - request for stopping runtimes**

**SYNOPSIS**

: **`gcloud notebooks runtimes stop` (`[RUNTIME](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/stop#RUNTIME)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/stop#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/stop#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/stop#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud notebooks runtimes stop example-runtime --location=us-central1
```
