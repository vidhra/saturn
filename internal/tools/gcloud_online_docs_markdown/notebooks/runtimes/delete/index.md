# gcloud notebooks runtimes delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/delete](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/delete)*

**NAME**

: **gcloud notebooks runtimes delete - request for deleting runtimes**

**SYNOPSIS**

: **`gcloud notebooks runtimes delete` (`[RUNTIME](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/delete#RUNTIME)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/delete#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/delete#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/runtimes/delete#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud notebooks runtimes delete example-runtime --location=us-central1
```
