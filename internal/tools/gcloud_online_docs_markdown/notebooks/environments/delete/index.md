# gcloud notebooks environments delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/environments/delete](https://cloud.google.com/sdk/gcloud/reference/notebooks/environments/delete)*

**NAME**

: **gcloud notebooks environments delete - request for deleting environments**

**SYNOPSIS**

: **`gcloud notebooks environments delete` (`[ENVIRONMENT](https://cloud.google.com/sdk/gcloud/reference/notebooks/environments/delete#ENVIRONMENT)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/environments/delete#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/notebooks/environments/delete#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/environments/delete#GCLOUD-WIDE-FLAGS) …`]**
...
: To delete environment with id 'example-environment' in location 'us-central1-a',
run:

```
gcloud notebooks environments delete example-environment --location=us-central1-a
```
