# gcloud notebooks instances stop  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/stop](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/stop)*

**NAME**

: **gcloud notebooks instances stop - request for stopping instances**

**SYNOPSIS**

: **`gcloud notebooks instances stop` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/stop#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/stop#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/stop#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/stop#GCLOUD-WIDE-FLAGS) …`]**
