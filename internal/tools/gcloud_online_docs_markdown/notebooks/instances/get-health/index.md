# gcloud notebooks instances get-health  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/get-health](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/get-health)*

**NAME**

: **gcloud notebooks instances get-health - request for checking if a notebook instance is healthy**

**SYNOPSIS**

: **`gcloud notebooks instances get-health` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/get-health#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/get-health#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/get-health#GCLOUD-WIDE-FLAGS) …`]**
