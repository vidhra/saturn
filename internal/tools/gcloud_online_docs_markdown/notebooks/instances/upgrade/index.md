# gcloud notebooks instances upgrade  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/upgrade](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/upgrade)*

**NAME**

: **gcloud notebooks instances upgrade - request for upgrading instances**

**SYNOPSIS**

: **`gcloud notebooks instances upgrade` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/upgrade#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/upgrade#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/upgrade#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/upgrade#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud notebooks instances upgrade example-instance --location=us-central1-a
```
