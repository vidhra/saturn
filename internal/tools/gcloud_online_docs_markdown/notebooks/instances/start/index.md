# gcloud notebooks instances start  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/start](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/start)*

**NAME**

: **gcloud notebooks instances start - request for starting instances**

**SYNOPSIS**

: **`gcloud notebooks instances start` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/start#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/start#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/start#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/start#GCLOUD-WIDE-FLAGS) …`]**
