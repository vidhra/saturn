# gcloud notebooks instances describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/describe](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/describe)*

**NAME**

: **gcloud notebooks instances describe - request for describing instances**

**SYNOPSIS**

: **`gcloud notebooks instances describe` (`[INSTANCE](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/describe#INSTANCE)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/notebooks/instances/describe#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud notebooks instances describe example-instance --location=us-central1-b
```
