...
*Source: [https://cloud.google.com/sdk/gcloud/reference/config](https://cloud.google.com/sdk/gcloud/reference/config)*
...
: **`gcloud config` `[GROUP](https://cloud.google.com/sdk/gcloud/reference/config#GROUP)` | `[COMMAND](https://cloud.google.com/sdk/gcloud/reference/config#COMMAND)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/config#GCLOUD-WIDE-FLAGS) …`]**
...
additional named configurations using `[gcloud init](https://cloud.google.com/sdk/gcloud/reference/init)` or `[gcloud config
configurations create](https://cloud.google.com/sdk/gcloud/reference/config/configurations/create)`.
...
To switch between configurations, use `[gcloud config
configurations activate](https://cloud.google.com/sdk/gcloud/reference/config/configurations/activate)`.
...
**`[get](https://cloud.google.com/sdk/gcloud/reference/config/get)`**:
...
**`[unset](https://cloud.google.com/sdk/gcloud/reference/config/unset)`**:
...
topic formats](https://cloud.google.com/sdk/gcloud/reference/topic/formats). Run `$ gcloud config set --help` to see more
information about `core/format`
