...
*Source: [https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/resume](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/resume)*
...
: **`gcloud scheduler jobs resume` (`[JOB](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/resume#JOB)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/resume#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/resume#GCLOUD-WIDE-FLAGS) …`]**
...
: **Job resource - The job to resume. The arguments in this group can be used to
