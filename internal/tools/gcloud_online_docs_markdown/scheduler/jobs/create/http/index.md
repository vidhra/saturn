# gcloud scheduler jobs create http  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http)*
...
: **`gcloud scheduler jobs create http` (`[JOB](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#JOB)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--location)`=`LOCATION`) `[--schedule](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--schedule)`=`SCHEDULE` `[--uri](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--uri)`=`URI` [`[--attempt-deadline](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--attempt-deadline)`=`ATTEMPT_DEADLINE`] [`[--description](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--description)`=`DESCRIPTION`] [`[--headers](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--headers)`=[`KEY`=`VALUE`,…]] [`[--http-method](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--http-method)`=`HTTP_METHOD`; default="post"] [`[--max-backoff](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--max-backoff)`=`MAX_BACKOFF`; default="1h"] [`[--max-doublings](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--max-doublings)`=`MAX_DOUBLINGS`; default=16] [`[--max-retry-attempts](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--max-retry-attempts)`=`MAX_RETRY_ATTEMPTS`] [`[--max-retry-duration](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--max-retry-duration)`=`MAX_RETRY_DURATION`] [`[--min-backoff](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--min-backoff)`=`MIN_BACKOFF`; default="5s"] [`[--time-zone](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--time-zone)`=`TIME_ZONE`; default="Etc/UTC"] [`[--message-body](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--message-body)`=`MESSAGE_BODY`     | `[--message-body-from-file](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--message-body-from-file)`=`PATH_TO_FILE`] [[`[--oauth-service-account-email](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--oauth-service-account-email)`=`OAUTH_SERVICE_ACCOUNT_EMAIL` : `[--oauth-token-scope](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--oauth-token-scope)`=`OAUTH_TOKEN_SCOPE`]     | [`[--oidc-service-account-email](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--oidc-service-account-email)`=`OIDC_SERVICE_ACCOUNT_EMAIL` : `[--oidc-token-audience](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#--oidc-token-audience)`=`OIDC_TOKEN_AUDIENCE`]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/scheduler/jobs/create/http#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud scheduler jobs create http my-job --schedule="0 */3 * * *" --uri="http://example.com/path" --http-method=GET
```
