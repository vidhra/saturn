# gcloud topic configurations  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/topic/configurations](https://cloud.google.com/sdk/gcloud/reference/topic/configurations)*
...
together as a group.
Configuration data is typically stored in $HOME/.config/gcloud, you can override
this location by setting the environment variable CLOUDSDK_CONFIG. This can be
useful if $HOME points to a read only filesystem or you are running commands
inside docker.
...
commands and may be modified by `[gcloud config set](https://cloud.google.com/sdk/gcloud/reference/config/set)` and
`[gcloud config
...
property values. Inactive configurations have no effect on gcloud executions.
...
Additionally, commands under `[gcloud config
configurations](https://cloud.google.com/sdk/gcloud/reference/config/configurations)` allow you to to list, activate, describe, and delete
