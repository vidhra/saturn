# gcloud datastream streams delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/datastream/streams/delete](https://cloud.google.com/sdk/gcloud/reference/datastream/streams/delete)*
...
: **`gcloud datastream streams delete` (`[STREAM](https://cloud.google.com/sdk/gcloud/reference/datastream/streams/delete#STREAM)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/datastream/streams/delete#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/datastream/streams/delete#GCLOUD-WIDE-FLAGS) …`]**
