# gcloud container bare-metal admin-clusters describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/container/bare-metal/admin-clusters/describe](https://cloud.google.com/sdk/gcloud/reference/container/bare-metal/admin-clusters/describe)*
...
: **`gcloud container bare-metal admin-clusters describe` (`[ADMIN_CLUSTER](https://cloud.google.com/sdk/gcloud/reference/container/bare-metal/admin-clusters/describe#ADMIN_CLUSTER)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/container/bare-metal/admin-clusters/describe#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/container/bare-metal/admin-clusters/describe#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud container bare-metal admin-clusters describe my-cluster --location=us-west1
```
