# gcloud container fleet scopes create  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create)*
...
: **`gcloud container fleet scopes create` `[SCOPE](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create#SCOPE)` [`[--async](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create#--async)`] [`[--labels](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create#--labels)`=[`KEY`=`VALUE`,…]] [`[--namespace-labels](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create#--namespace-labels)`=[`KEY`=`VALUE`,…]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create#GCLOUD-WIDE-FLAGS) …`]**
