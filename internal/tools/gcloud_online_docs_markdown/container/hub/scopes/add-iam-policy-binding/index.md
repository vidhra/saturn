# gcloud container hub scopes add-iam-policy-binding  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/container/hub/scopes/add-iam-policy-binding](https://cloud.google.com/sdk/gcloud/reference/container/hub/scopes/add-iam-policy-binding)*
...
: **`gcloud container hub scopes add-iam-policy-binding` `[SCOPE](https://cloud.google.com/sdk/gcloud/reference/container/hub/scopes/add-iam-policy-binding#SCOPE)` `[--member](https://cloud.google.com/sdk/gcloud/reference/container/hub/scopes/add-iam-policy-binding#--member)`=`PRINCIPAL` `[--role](https://cloud.google.com/sdk/gcloud/reference/container/hub/scopes/add-iam-policy-binding#--role)`=`ROLE` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/container/hub/scopes/add-iam-policy-binding#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud container hub scopes add-iam-policy-binding my-scope --member='user:test-user@gmail.com' --role='roles/gkehub.scopeUser'
```
