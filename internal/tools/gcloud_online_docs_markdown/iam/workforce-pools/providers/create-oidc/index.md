# gcloud iam workforce-pools providers create-oidc  |  Google Cloud CLI Documentation
...
: The following command creates a disabled OIDC workforce pool provider with the
