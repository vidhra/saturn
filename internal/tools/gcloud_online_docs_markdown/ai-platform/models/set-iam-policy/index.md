# gcloud ai-platform models set-iam-policy  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ai-platform/models/set-iam-policy](https://cloud.google.com/sdk/gcloud/reference/ai-platform/models/set-iam-policy)*

**NAME**

: **gcloud ai-platform models set-iam-policy - set the IAM policy for a model**

**SYNOPSIS**

: **`gcloud ai-platform models set-iam-policy` `[MODEL](https://cloud.google.com/sdk/gcloud/reference/ai-platform/models/set-iam-policy#MODEL)` `[POLICY_FILE](https://cloud.google.com/sdk/gcloud/reference/ai-platform/models/set-iam-policy#POLICY_FILE)` [`[--region](https://cloud.google.com/sdk/gcloud/reference/ai-platform/models/set-iam-policy#--region)`=`REGION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ai-platform/models/set-iam-policy#GCLOUD-WIDE-FLAGS) …`]**
