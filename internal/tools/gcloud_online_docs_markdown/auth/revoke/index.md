...
*Source: [https://cloud.google.com/sdk/gcloud/reference/auth/revoke](https://cloud.google.com/sdk/gcloud/reference/auth/revoke)*
...
: **`gcloud auth revoke` [`[ACCOUNTS](https://cloud.google.com/sdk/gcloud/reference/auth/revoke#ACCOUNTS)` …] [`[--all](https://cloud.google.com/sdk/gcloud/reference/auth/revoke#--all)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/auth/revoke#GCLOUD-WIDE-FLAGS) …`]**
