# gcloud assured workloads describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/assured/workloads/describe](https://cloud.google.com/sdk/gcloud/reference/assured/workloads/describe)*

**NAME**

: **gcloud assured workloads describe - describe Assured Workloads environment**

**SYNOPSIS**

: **`gcloud assured workloads describe` (`[WORKLOAD](https://cloud.google.com/sdk/gcloud/reference/assured/workloads/describe#WORKLOAD)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/assured/workloads/describe#--location)`=`LOCATION` `[--organization](https://cloud.google.com/sdk/gcloud/reference/assured/workloads/describe#--organization)`=`ORGANIZATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/assured/workloads/describe#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud assured workloads describe organizations/123/locations/us-central1/workloads/456
```
