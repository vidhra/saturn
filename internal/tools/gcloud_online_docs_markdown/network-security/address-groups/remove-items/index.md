# gcloud network-security address-groups remove-items  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items](https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items)*
...
: **`gcloud network-security address-groups remove-items` (`[ADDRESS_GROUP](https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items#ADDRESS_GROUP)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items#--async)`] [`[--items](https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items#--items)`=[`ITEMS`,…]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud network-security address-groups remove-items my-address-group --items=192.168.1.1
```
