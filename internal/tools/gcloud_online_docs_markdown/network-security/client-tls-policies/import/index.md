# gcloud network-security client-tls-policies import  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/network-security/client-tls-policies/import](https://cloud.google.com/sdk/gcloud/reference/network-security/client-tls-policies/import)*
...
: **`gcloud network-security client-tls-policies import` (`[CLIENT_TLS_POLICY](https://cloud.google.com/sdk/gcloud/reference/network-security/client-tls-policies/import#CLIENT_TLS_POLICY)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/network-security/client-tls-policies/import#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/network-security/client-tls-policies/import#--async)`] [`[--source](https://cloud.google.com/sdk/gcloud/reference/network-security/client-tls-policies/import#--source)`=`SOURCE`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/network-security/client-tls-policies/import#GCLOUD-WIDE-FLAGS) …`]**
