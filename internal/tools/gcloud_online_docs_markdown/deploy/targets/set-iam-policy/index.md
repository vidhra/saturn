# gcloud deploy targets set-iam-policy  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/deploy/targets/set-iam-policy](https://cloud.google.com/sdk/gcloud/reference/deploy/targets/set-iam-policy)*
...
: **`gcloud deploy targets set-iam-policy` (`[TARGET](https://cloud.google.com/sdk/gcloud/reference/deploy/targets/set-iam-policy#TARGET)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/deploy/targets/set-iam-policy#--region)`=`REGION`) `[POLICY_FILE](https://cloud.google.com/sdk/gcloud/reference/deploy/targets/set-iam-policy#POLICY_FILE)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/deploy/targets/set-iam-policy#GCLOUD-WIDE-FLAGS) …`]**
...
``policy.json`` and set it for a target with
