# gcloud managed-kafka clusters delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/managed-kafka/clusters/delete](https://cloud.google.com/sdk/gcloud/reference/managed-kafka/clusters/delete)*
...
: **`gcloud managed-kafka clusters delete` (`[CLUSTER](https://cloud.google.com/sdk/gcloud/reference/managed-kafka/clusters/delete#CLUSTER)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/managed-kafka/clusters/delete#--location)`=`LOCATION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/managed-kafka/clusters/delete#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/managed-kafka/clusters/delete#GCLOUD-WIDE-FLAGS) …`]**
...
: To delete a cluster named mycluster located in us-central1, run the following:

```
gcloud managed-kafka clusters delete mycluster --location=us-central1
```

**POSITIONAL ARGUMENTS**

: **Cluster resource - Identifies the cluster for deletion. The arguments in this
