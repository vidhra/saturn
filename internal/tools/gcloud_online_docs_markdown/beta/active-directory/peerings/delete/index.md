# gcloud beta active-directory peerings delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/beta/active-directory/peerings/delete](https://cloud.google.com/sdk/gcloud/reference/beta/active-directory/peerings/delete)*
...
: **`gcloud beta active-directory peerings delete` `[PEERING](https://cloud.google.com/sdk/gcloud/reference/beta/active-directory/peerings/delete#PEERING)` [`[--async](https://cloud.google.com/sdk/gcloud/reference/beta/active-directory/peerings/delete#--async)`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/beta/active-directory/peerings/delete#GCLOUD-WIDE-FLAGS) …`]**

**DESCRIPTION**

: `(BETA)` Delete a Managed Microsoft Active Directory (AD) domain
peering.
