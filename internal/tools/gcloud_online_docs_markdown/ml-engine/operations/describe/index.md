# gcloud ml-engine operations describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ml-engine/operations/describe](https://cloud.google.com/sdk/gcloud/reference/ml-engine/operations/describe)*
...
: **`gcloud ml-engine operations describe` `[OPERATION](https://cloud.google.com/sdk/gcloud/reference/ml-engine/operations/describe#OPERATION)` [`[--region](https://cloud.google.com/sdk/gcloud/reference/ml-engine/operations/describe#--region)`=`REGION`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ml-engine/operations/describe#GCLOUD-WIDE-FLAGS) …`]**
