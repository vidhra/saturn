# gcloud ml-engine models get-iam-policy  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy)*
...
: **`gcloud ml-engine models get-iam-policy` `[MODEL](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy#MODEL)` [`[--region](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy#--region)`=`REGION`] [`[--filter](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy#--filter)`=`EXPRESSION`] [`[--limit](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy#--limit)`=`LIMIT`] [`[--page-size](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy#--page-size)`=`PAGE_SIZE`] [`[--sort-by](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy#--sort-by)`=[`FIELD`,…]] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/ml-engine/models/get-iam-policy#GCLOUD-WIDE-FLAGS) …`]**
