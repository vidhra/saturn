# gcloud data-catalog entry-groups delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/data-catalog/entry-groups/delete](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entry-groups/delete)*
...
: **`gcloud data-catalog entry-groups delete` (`[ENTRY_GROUP](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entry-groups/delete#ENTRY_GROUP)` : `[--location](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entry-groups/delete#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entry-groups/delete#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud data-catalog entry-groups delete group1 --location=us-central1
```

**POSITIONAL ARGUMENTS**

: **Entry group resource - Entry group to delete. The arguments in this group can be
