# gcloud data-catalog entries delete  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/data-catalog/entries/delete](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entries/delete)*
...
: **`gcloud data-catalog entries delete` (`[ENTRY](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entries/delete#ENTRY)` : `[--entry-group](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entries/delete#--entry-group)`=`ENTRY_GROUP` `[--location](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entries/delete#--location)`=`LOCATION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/data-catalog/entries/delete#GCLOUD-WIDE-FLAGS) …`]**
...
```
gcloud data-catalog entries delete entry1 --entry-group=group1 --location=us-central1
```
