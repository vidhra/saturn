# gcloud workspace-add-ons deployments describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/workspace-add-ons/deployments/describe](https://cloud.google.com/sdk/gcloud/reference/workspace-add-ons/deployments/describe)*

**NAME**

: **gcloud workspace-add-ons deployments describe - describe a Google Workspace Add-ons deployment**

**SYNOPSIS**

: **`gcloud workspace-add-ons deployments describe` `[DEPLOYMENT](https://cloud.google.com/sdk/gcloud/reference/workspace-add-ons/deployments/describe#DEPLOYMENT)` [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/workspace-add-ons/deployments/describe#GCLOUD-WIDE-FLAGS) …`]**
