# gcloud dataproc clusters import  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/import](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/import)*
...
: **`gcloud dataproc clusters import` (`[CLUSTER](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/import#CLUSTER)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/import#--region)`=`REGION`) [`[--async](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/import#--async)`] [`[--source](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/import#--source)`=`SOURCE`] [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/import#GCLOUD-WIDE-FLAGS) …`]**
