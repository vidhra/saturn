# gcloud dataproc clusters describe  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/describe](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/describe)*
...
: **`gcloud dataproc clusters describe` (`[CLUSTER](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/describe#CLUSTER)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/describe#--region)`=`REGION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/describe#GCLOUD-WIDE-FLAGS) …`]**
