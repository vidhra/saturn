# gcloud dataproc batches cancel  |  Google Cloud CLI Documentation

*Source: [https://cloud.google.com/sdk/gcloud/reference/dataproc/batches/cancel](https://cloud.google.com/sdk/gcloud/reference/dataproc/batches/cancel)*
...
: **`gcloud dataproc batches cancel` (`[BATCH](https://cloud.google.com/sdk/gcloud/reference/dataproc/batches/cancel#BATCH)` : `[--region](https://cloud.google.com/sdk/gcloud/reference/dataproc/batches/cancel#--region)`=`REGION`) [`[GCLOUD_WIDE_FLAG](https://cloud.google.com/sdk/gcloud/reference/dataproc/batches/cancel#GCLOUD-WIDE-FLAGS) …`]**
