...
class MCPEnhancedKnowledgeBase:
    ...
    def __init__(self, knowledge_base: KnowledgeBase, mcp_integrator: Optional[MCPToolIntegrator] = None):
        ...
        if self.mcp_integrator:
            ...
            return {
                **base_counts,
                ...
                "total_tools_with_mcp": base_counts["total_tools"] + mcp_summary["mcp_tools"]
            }
    ...
    async def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Handle Saturn file build tools
        from saturn.file_build_tools import create_file_build_tools_for_llm
        saturn_tools = create_file_build_tools_for_llm()
